...
public class aw extends GameOutputStream {
    ...
    public aw() {
        ...
        this.f574a = new ByteArrayOutputStream();
        this.e = new PrintStream(this.f574a);
        b();
    }
    ...
    public Packet a(int i, int i2) {
        try {
            ...
            packet.bytes = this.f574a.toByteArray();
            packet.f0d = i2;
            return packet;
        } catch (IOException e) {
    ...
    public void a(PlayerConnect playerConnect) {
        if (playerConnect == null) {
            ...
            this.f.println(playerConnect.c);
        }
    }
