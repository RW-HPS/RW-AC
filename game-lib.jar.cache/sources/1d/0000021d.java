...
public class n extends com.corrodinggames.rts.game.units.f.i {
    ...
    public com.corrodinggames.rts.game.units.custom.h f230a;
    public float b;
    public boolean c;
    public q d;
    ...
    public void callback(y yVar, float f, am amVar) {
        ...
        if ((this.f230a == null || (de != null && com.corrodinggames.rts.game.units.custom.g.a(this.f230a, de))) && com.corrodinggames.rts.gameFramework.f.a(yVar.eo, yVar.ep, amVar.eo, amVar.ep) < this.b) {
