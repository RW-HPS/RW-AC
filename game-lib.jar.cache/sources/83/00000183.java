...
public class h {
    ...
    public void a() {
        ...
        this.c = gameEngine.bO.mo10b(this.b);
        if (this.j) {
            this.b.m = true;
        }
        if (this.k != null) {
    ...
    public int a(TileSet tileSet, int i) {
        int a;
        tileSet.a(i, l);
        if (this.a >= 400) {
            return -1;
        ...
        if (z) {
            ...
            a(i2, tileSet.b, l);
            return i2;
        } else if (this.k != null && (a = this.k.a(tileSet, i)) != -1) {
            return a + 500;
        } else {
            return -1;
        }
    ...
    public static boolean a(e eVar, Rect rect) {
        int i = rect.a;
        int i2 = rect.c;
        int i3 = rect.b;
        int i4 = rect.d;
        ...
        if (!eVar.k()) {
            GameEngine.m5e("hasImageAlpha: Cannot get pixel data for: " + eVar.a());
            return true;
        }
        eVar.x();
    ...
    public void a(int i, e eVar, Rect rect) {
        Rect rect2 = new Rect();
        a(i, rect2);
        boolean z = false;
        if (this.i < 1.0f) {
    ...
    public static void a(y yVar, e eVar, Rect rect, Rect rect2, Paint paint) {
        for (int i = 0; i <= 3; i++) {
            a(rect, m, i, 0);
            a(rect2, n, i, 1);
