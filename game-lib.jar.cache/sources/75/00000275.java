...
public class c {
    ...
    static final Rect f283a = new Rect();
    ...
    public void a(l lVar) {
        Object[] a2 = this.d.a();
        for (int i = this.d.f689a - 1; i >= 0; i--) {
            e eVar = (e) a2[i];
            a a3 = lVar.a(eVar.f285a.g);
            if (a3 != null) {
                eVar.f285a = a3;
                while (eVar.b.size() > eVar.f285a.d) {
    ...
    public void a(float f2, am amVar) {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            ...
            for (int i4 = i3 - 1; i4 >= 0; i4--) {
                d dVar = (d) a3[i4];
                if (dVar.c) {
                    am amVar2 = dVar.f284a;
                    if (aVar.e != null) {
                        com.corrodinggames.rts.gameFramework.m.e eVar2 = aVar.e;
                        ...
                        f283a.a(0, (int) (eVar2.q - f5), eVar2.p, eVar2.q);
                        ...
                        gameEngine.bO.a(eVar2, f283a, b, agVar);
                        gameEngine.bO.l();
                    }
                    if (aVar.f != null) {
    ...
    public void a(GameOutputStream gameOutputStream) {
        ...
        for (int i = 0; i < size; i++) {
            e eVar = (e) a2[i];
            gameOutputStream.a(eVar.f285a.g);
            gameOutputStream.a((short) eVar.b.size());
            Iterator it = eVar.b.iterator();
            while (it.hasNext()) {
                d dVar = (d) it.next();
                gameOutputStream.a(dVar.f284a);
    ...
    public void a(am amVar, GameInputStream gameInputStream) {
        ...
        for (int i = 0; i < readShort; i++) {
            ...
            for (int i2 = 0; i2 < readShort2; i2++) {
                d dVar = new d();
                dVar.f284a = gameInputStream.a(com.corrodinggames.rts.gameFramework.net.m.expected);
                dVar.b = gameInputStream.readBoolean();
                dVar.c = gameInputStream.readBoolean();
                if (dVar.f284a != null && eVar != null) {
                    eVar.b.add(dVar);
                }
            }
        }
