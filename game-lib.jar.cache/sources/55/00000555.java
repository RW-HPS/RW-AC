...
/* renamed from: com.corrodinggames.rts.gameFramework.k.l */
...
public final class PathEngine {
    ...
    public synchronized void a(b bVar, boolean z) {
        d();
        GameEngine.m5e("PathEngine: Setting up map costs");
        boolean z2 = false;
        if (z && this.q != null && this.q == bVar && this.s == bVar.u.n && this.t == bVar.u.o) {
            if (this.r == i.a(bVar)) {
                GameEngine.m5e("PathEngine: Keeping existing map costs");
                z2 = true;
            } else {
                GameEngine.m5e("PathEngine: Error: Map checksum does not match!!!");
            }
        }
        if (z2) {
        }
        ...
        this.o.a(bVar);
        GameEngine.m5e("PathEngine: Ready");
    }
    ...
    public void a(k kVar, boolean z, boolean z2) {
        ...
        kVar.e();
        kVar.t = 300.0f;
        int d2 = f.d(kVar.h - kVar.l);
        int d3 = f.d(kVar.i - kVar.m);
        if (d2 < 15 && d3 < 15) {
            kVar.t = 12.0f;
        } else if (d2 < 50 && d3 < 50) {
            kVar.t = 16.0f;
    ...
    public String f() {
        ...
        while (it.hasNext()) {
            ...
            if (kVar.t <= 0.0f && !kVar.c()) {
                if (str == null) {
                    str = "[distance:" + f.b(kVar.h, kVar.i, kVar.l, kVar.m) + ", allowedDelay:" + kVar.s + " lowPriority:" + kVar.r + "]";
                }
                i2++;
            }
        }
