...
public class o extends com.corrodinggames.rts.game.units.custom.a.a {
    ...
    public static void a(com.corrodinggames.rts.game.units.custom.l lVar, ab abVar, String str, String str2, com.corrodinggames.rts.game.units.custom.a.d dVar, String str3, boolean z) {
        bp a = bp.a(lVar, abVar, str, str2 + "addUnitsIntoTransport");
        int intValue = abVar.b(str, str2 + "deleteNumUnitsFromTransport", (Integer) 0).intValue();
        com.corrodinggames.rts.game.units.custom.h a2 = com.corrodinggames.rts.game.units.custom.g.a(abVar.b(str, "deleteNumUnitsFromTransport_onlyWithTags", (String) null), (com.corrodinggames.rts.game.units.custom.h) null);
        ...
        if (!a.b() || intValue > 0 || booleanValue || booleanValue2 || b != null) {
            o oVar = new o();
            if (!a.b()) {
                oVar.a = a;
            }
