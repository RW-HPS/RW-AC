...
public class d extends com.corrodinggames.rts.game.units.custom.a.a {
    ...
    public static void a(com.corrodinggames.rts.game.units.custom.l lVar, ab abVar, String str, String str2, com.corrodinggames.rts.game.units.custom.a.d dVar, String str3, boolean z) {
        ...
        com.corrodinggames.rts.game.units.custom.o a2 = lVar.a(abVar.b(str, str2 + "playAnimation", (String) null), (com.corrodinggames.rts.game.units.custom.o) null);
        com.corrodinggames.rts.game.units.custom.o a3 = lVar.a(abVar.b(str, str2 + "playAnimationIfNotPlaying", (String) null), (com.corrodinggames.rts.game.units.custom.o) null);
        if (a2 != null && a3 != null) {
        ...
        if (a2 != null || a3 != null || booleanValue || booleanValue2) {
            d dVar2 = new d();
            dVar2.f220a = booleanValue;
