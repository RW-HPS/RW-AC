...
public class ba {
    ...
    public static void a(ba baVar, l lVar, com.corrodinggames.rts.gameFramework.utility.ab abVar, String str, boolean z, ArrayList arrayList) {
        ...
        baVar.c = z;
        Float a2 = abVar.a(str, "attach_x", (Float) null);
        if (a2 != null) {
            baVar.j = a2.floatValue();
        }
        Float a3 = abVar.a(str, "attach_y", (Float) null);
        if (a3 != null) {
            baVar.k = a3.floatValue();
        }
        ...
        Float a4 = abVar.a(str, "moveSpeed", (Float) null);
        if (a4 != null) {
            baVar.s = a4.floatValue();
        }
        ...
        Float a5 = abVar.a(str, "resetAngle", (Float) null);
        if (a5 != null) {
            baVar.w = a5.floatValue();
        }
        boolean booleanValue = abVar.a(str, "image_end_teamColors", (Boolean) false).booleanValue();
        com.corrodinggames.rts.gameFramework.m.e a6 = lVar.a(abVar, str, "image_foot");
        if (a6 != null) {
            baVar.B = a6;
            if (booleanValue) {
        ...
        com.corrodinggames.rts.gameFramework.m.e a7 = lVar.a(abVar, str, "image_end");
        if (a7 != null) {
            baVar.B = a7;
            if (booleanValue) {
                baVar.C = lVar.a(baVar.B, lVar.ac);
        ...
        com.corrodinggames.rts.gameFramework.m.e a8 = lVar.a(abVar, str, "image_foot_shadow");
        if (a8 != null) {
            baVar.D = a8;
        }
        com.corrodinggames.rts.gameFramework.m.e a9 = lVar.a(abVar, str, "image_end_shadow");
        if (a9 != null) {
            baVar.D = a9;
        }
        com.corrodinggames.rts.gameFramework.m.e a10 = lVar.a(abVar, str, "image_leg");
        if (a10 != null) {
            baVar.x = a10;
        }
        com.corrodinggames.rts.gameFramework.m.e a11 = lVar.a(abVar, str, "image_middle");
        if (a11 != null) {
            baVar.x = a11;
        }
        ...
        Float a12 = abVar.a(str, "heightSpeed", (Float) null);
        if (a12 != null) {
            baVar.v = a12.floatValue();
        }
        Boolean a13 = abVar.a(str, "draw_foot_on_top", (Boolean) null);
        if (a13 != null) {
            baVar.H = a13.booleanValue();
        }
        Boolean a14 = abVar.a(str, "dust_effect", (Boolean) null);
        if (a14 != null) {
            baVar.I = a14.booleanValue();
        }
        Boolean a15 = abVar.a(str, "drawLegWhenZoomedOut", (Boolean) null);
        if (a15 != null) {
            baVar.F = a15.booleanValue();
            baVar.E = true;
        }
        Boolean a16 = abVar.a(str, "drawFootWhenZoomedOut", (Boolean) null);
        if (a16 != null) {
            baVar.G = a16.booleanValue();
            baVar.E = true;
        }
        ...
        Boolean a17 = abVar.a(str, "explodeOnDeath", (Boolean) null);
        if (a17 != null) {
            baVar.J = a17.booleanValue();
        }
        Float a18 = abVar.a(str, "holdDisMin", (Float) null);
        if (a18 != null) {
            baVar.K = a18.floatValue();
        }
        ...
        Float a19 = abVar.a(str, "holdDisMax", (Float) null);
        if (a19 != null) {
            baVar.N = a19.floatValue();
        }
        Float a20 = abVar.a(str, "hardLimit", (Float) null);
        if (a20 != null) {
            baVar.O = a20.floatValue();
        }
