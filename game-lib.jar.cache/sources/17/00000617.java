...
public final class i {
    ...
    public void b() {
        synchronized (this) {
            ...
            AssetManager d = this.f684a.d();
            ArrayList arrayList = new ArrayList();
            try {
                GameEngine.m328e("------- createIndex -------");
    ...
    public ArrayList c() {
        if (this.c != null) {
            if (this.b) {
                GameEngine.m328e("assetIndex: getFile was not blocked on load");
                this.b = false;
            }
            return this.c;
        }
        ...
        b();
        if (this.b) {
            GameEngine.m328e("assetIndex: getFile is BLOCKED on load");
            this.b = false;
        }
        return this.c;
    }
