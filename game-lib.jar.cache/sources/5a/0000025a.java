...
public class h extends a {
    ...
    public static final a f259a = new h();
    ...
    public void b(com.corrodinggames.rts.game.units.custom.j jVar, float f) {
        com.corrodinggames.rts.gameFramework.d.e c2;
        ...
        for (int i2 = 0; i2 < iVarArr.length; i2++) {
            ...
            if ((baVar.P == z || baVar.D != null) && baVar.Q == z2 && !baVar.p && (baVar.q == null || !baVar.q.read(jVar))) {
                ...
                if (iVar.s > 0.0f) {
                    ...
                    com.corrodinggames.rts.gameFramework.m.y yVar = gameEngine.bO;
                    if (cD != 1.0f) {
                        yVar.k();
                        yVar.a(cD, cD, f6, f7);
                    }
                    ...
                    if (baVar.P == z) {
                        com.corrodinggames.rts.gameFramework.m.e eVar = baVar.B;
                        if (baVar.C != null) {
                        ...
                        com.corrodinggames.rts.gameFramework.m.e eVar2 = baVar.x;
                        if (baVar.y != null) {
