...
public class a {
    ...
    /* renamed from: a */
    public static final FileLoader f476a = new FileLoader();
    public static FileLoader b = f476a;
    ...
    public static void b() {
        ...
        if (GameEngine.at()) {
            if (Build.VERSION.SDK_INT < 19) {
                ...
                GameEngine.m3e("FileLoader: SDK too old, not changing FileLoader");
                return;
            }
            int i = GameEngine.getGameEngine().settingsEngine.storageType;
            GameEngine.m3e("FileLoader: storageBehaviour:" + i);
            FileLoader a2 = a(i);
            GameEngine.m3e("Using file loader: " + a2.d());
            b = a2;
        }
    }
    ...
    public static FileLoader a(int i) {
        ...
        if (Build.VERSION.SDK_INT >= 19) {
            ...
            if (!a3.f477a) {
                ...
                GameEngine.m3e("FileLoader using overriddenExternalPath:" + d);
