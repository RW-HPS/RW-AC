...
public abstract class b extends LibRocket {
    ...
    public static String a(String str) {
        GameEngine.m5e("convertTexturePath for: " + str);
        String o = f.o(str);
        ...
        if (o.startsWith("assets:")) {
            ...
            GameEngine.m5e("convertTexturePath  (basePath:" + z + "):" + substring + " > " + e);
            if (z) {
                return b + e;
            }
            return e;
        } else if (o.startsWith(b + "assets/gui/")) {
            GameEngine.m5e("convertTexturePath already had path:" + o);
            return o;
        } else {
    ...
    public boolean b(d dVar) {
        if (this.j != null) {
            GameEngine.m5e("AlertPopup already visible closing");
            closeDocument(this.j.a);
            this.j = null;
        }
        this.j = dVar;
        GameEngine.m5e("Showing popup: " + dVar.b);
        if (!this.e) {
            update();
        } else {
            GameEngine.m5e("insideEvent");
        }
        GameEngine.m5e("popup ready..");
        dVar.a.show(4);
        GameEngine.m5e("Popup shown..");
        return true;
    }
    ...
    public boolean c(d dVar) {
        if (this.k != null) {
            GameEngine.m5e("Popup already visible, cannot show: " + dVar.a.getMetadata("sourceDocumentId"));
            if (this.j != null) {
                this.j.a.pullToFront();
                return false;
            }
    ...
    public void a(Element element, boolean z) {
        if (element == null) {
            GameEngine.m5e("loadCharsetIfNeededOnChildren: root is null");
            return;
        }
    ...
    public boolean i() {
        d dVar = this.j;
        if (dVar != null) {
            GameEngine.m5e("Closing alert");
            closeDocument(dVar.a);
            this.j = null;
            if (dVar.i != null) {
                dVar.i.run();
                return true;
