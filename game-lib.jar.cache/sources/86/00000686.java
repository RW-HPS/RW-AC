...
public class o extends com.corrodinggames.rts.gameFramework.a.h {
    ...
    public void a(Context context) {
        if (this.e != null) {
            GameEngine.m328e("SlickSoundFactory:setContext context already set");
        } else {
            this.e = context;
        }
    }
    ...
    public com.corrodinggames.rts.gameFramework.a.i a(int i) {
        ...
        synchronized (b()) {
            qVar.f755a = this.f.newSound(new com.corrodinggames.rts.java.audio.a.a(f));
        }
        return qVar;
    }
    ...
    public com.corrodinggames.rts.gameFramework.a.i a(String str, com.corrodinggames.rts.gameFramework.utility.j jVar, boolean z) {
        ...
        try {
            synchronized (b()) {
                qVar.f755a = this.f.newSound(new com.corrodinggames.rts.java.audio.a.a(jVar, jVar.d()));
            }
            return qVar;
