...
public class z extends s {
    ...
    @Override // com.corrodinggames.rts.game.units.a.s
    public t f() {
        if (GameEngine.at() && !InterfaceEngine.bO) {
    ...
    public boolean c(am amVar, boolean z) {
        ...
        if (!z) {
            ...
            while (it.hasNext()) {
                ...
                if (amVar2.cG && amVar2.mo1r() != this.a) {
        ...
        while (it2.hasNext()) {
            ...
            if (amVar3.cG && amVar3.mo1r() == this.a) {
    ...
    public String d() {
        ...
        return VariableScope.nullOrMissingString + this.a.e() + " x" + this.c;
    }
