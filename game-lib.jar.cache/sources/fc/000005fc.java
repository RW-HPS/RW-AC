...
class b {
    ...
    public b(Uri uri, boolean z) {
        this.a = uri;
        this.b = a.a.buildDocumentUriUsingTree(uri);
        this.c = a.a.getReadablePath(c(), uri);
        this.d = z;
    ...
    public j b(String str) {
        ...
        try {
            InputStream read = a.a.read(c(), f);
            if (read == null) {
                return null;
            }
            return new j(read, this.a + "/" + str);
    ...
    public long c(String str) {
        ...
        return a.a.getLastModified(c(), f);
    }
    ...
    public OutputStream a(String str, boolean z) {
        ...
        if (f == null) {
            ...
            try {
                f = a.a.createFile(c(), i, VariableScope.nullOrMissingString, name);
                a.i("newFileUri: " + f);
            } catch (FileNotFoundException e) {
                e.printStackTrace();
                return null;
        ...
        try {
            OutputStream write = a.a.write(c(), f, str2);
            a();
            return write;
    ...
    public boolean a(String str, String str2) {
        ...
        a.i("Rename: " + f + " to " + k);
        try {
            Uri renameFile = a.a.renameFile(c(), f, k);
            a();
    ...
    public boolean j(String str) {
        ...
        Uri createDirectory = a.a.createDirectory(c(), i, name);
        a();
