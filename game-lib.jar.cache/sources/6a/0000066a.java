...
public class SteamEngine extends com.corrodinggames.rts.gameFramework.steam.SteamEngine {
    ...
    public void b() {
        if (this.k) {
            GameEngine.m5e("SteamEngine - init already called");
            return;
        }
        this.k = true;
        GameEngine.m5e("SteamEngine - java steamEngine init()");
        try {
            if (!SteamAPI.init()) {
    ...
    public void a(float f) {
        ...
        if (this.h != null) {
            if (GameEngine.aK != null) {
                GameEngine.m5e("Joining game from commandline invite:" + GameEngine.aK);
            ...
            while (true) {
                ...
                if (isP2PPacketAvailable != 0) {
                    ...
                    try {
                        ...
                        if (steamSocket == null) {
                            GameEngine.m5e("Could not find remote ID steamSocket: " + steamID);
                        } else {
    ...
    public void d() {
        ...
        if (gameEngine != null) {
            ...
            GameEngine.m5e("cannot show alert game has not been created");
        }
    ...
    public PlayerConnect b(SteamID steamID) {
        GameEngine.m5e("addPeer: " + steamID);
        GameEngine gameEngine = GameEngine.getGameEngine();
        SteamSocket steamSocket = (SteamSocket) this.l.get(steamID);
        if (steamSocket != null) {
        ...
        PlayerConnect playerConnect = new PlayerConnect(gameEngine.netEngine, steamSocket2);
        try {
            playerConnect.i = true;
            playerConnect.d();
            gameEngine.netEngine.socketList.add(playerConnect);
    ...
    public void c(final SteamID steamID) {
        GameEngine.m5e("connectTo: " + steamID);
        SteamSocket steamSocket = (SteamSocket) this.l.get(steamID);
        if (steamSocket != null) {
            if (steamSocket.isClosed()) {
                this.l.remove(steamID);
            ...
            ScriptEngine.getInstance().addRunnableToQueue(new Runnable() { // from class: com.corrodinggames.rts.java.c.b.1
                ...
                public void run() {
                    ...
                    try {
                        ...
                        gameEngine.netEngine.bindSocket(steamSocket2);
