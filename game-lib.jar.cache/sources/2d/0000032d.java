...
public abstract class LogicString extends LogicBoolean {
    ...
    public class WrappingLogicString extends LogicString {
        ...
        public void setArgumentsRaw(String str, l lVar, String str2) {
            ...
            this.children = new LogicBoolean[a2.size()];
            for (int i = 0; i < a2.size(); i++) {
                this.children[i] = LogicBooleanLoader.parseBooleanBlock(lVar, (String) a2.get(i), false);
    ...
    public class StringCast extends LogicString {
        ...
        public void setArgumentsRaw(String str, l lVar, String str2) {
            ...
            ArrayList a2 = al.a(str, ",", false);
            validateNumberOfArguments(a2.size());
            this.child = LogicBooleanLoader.parseBooleanBlock(lVar, (String) a2.get(0), false);
            if (this.child == null) {
                throw new BooleanParseException("Expected non-null argument");
            }
        }
    ...
    public class Select extends LogicString {
        ...
        public void setArgumentsRaw(String str, l lVar, String str2) {
            ...
            ArrayList a2 = al.a(str, ",", false);
            validateNumberOfArguments(a2.size());
            this.selector = LogicBooleanLoader.parseBooleanBlock(lVar, (String) a2.get(0), true);
            if (this.selector == null) {
                throw new BooleanParseException("Expected non-null argument");
            }
            this.childA = LogicBooleanLoader.parseBooleanBlock(lVar, (String) a2.get(1), false);
            if (this.childA == null) {
                throw new BooleanParseException("Expected non-null argument");
            }
            this.childB = LogicBooleanLoader.parseBooleanBlock(lVar, (String) a2.get(2), false);
            if (this.childB == null) {
                throw new BooleanParseException("Expected non-null argument");
            }
