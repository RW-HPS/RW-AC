...
public class c extends a {
    ...
    public static c a(l lVar, String str, boolean z) {
        ...
        while (it.hasNext()) {
            ...
            if (trim.equals("hasFlag")) {
                ...
                cVar.f289a.add(new d(j, parseNumberBlock));
            }
        }
        return cVar;
    }
    ...
    public boolean b(am amVar, double d) {
        ...
        y yVar = (y) amVar;
        int i = this.f289a.f689a;
        Object[] a2 = this.f289a.a();
        for (int i2 = 0; i2 < i; i2++) {
            ...
            if (d2 > 0.0d && dVar.f290a.a(yVar) < d2) {
                return false;
            }
        }
        if (!g(yVar)) {
