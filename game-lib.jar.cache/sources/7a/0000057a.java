...
public final class o extends u {
    ...
    public void a(e eVar, float f, float f2, Paint paint) {
        ...
        s a = a(p.drawBitmap_Bitmap_float_float_Paint);
        a.b[0] = eVar;
        a.b[1] = paint;
        a.c = f;
        a.d = f2;
    ...
    public void a(e eVar, Rect rect, Rect rect2, Paint paint) {
        ...
        Rect a2 = this.e.a(rect2);
        if (!(paint instanceof ag)) {
            paint = this.d.a(paint);
        }
        a(p.drawBitmap_Bitmap_Rect_Rect_Paint, eVar, a, a2, paint);
    }
    ...
    public void a(e eVar, Rect rect, RectF rectF, Paint paint) {
        ...
        a(p.drawBitmap_Bitmap_Rect_RectF_Paint, eVar, a, a2, paint);
    }
    ...
    public void a(float f, float f2, float f3, float f4, Paint paint) {
        ...
        s a = a(p.drawLine_float_float_float_float_Paint);
        a.c = f;
        a.d = f2;
        a.e = f3;
        a.f = f4;
    ...
    public void a(Rect rect, Paint paint) {
        ...
        a(p.drawRect_Rect_Paint, a, paint);
    }
    ...
    public void a(RectF rectF, Paint paint) {
        ...
        a(p.drawRect_RectF_Paint, a, paint);
    }
    ...
    public void a(float f, float f2, float f3) {
        s a = a(p.rotate_float_float_float);
        a.c = f;
        a.d = f2;
        a.e = f3;
    }
    ...
    public void a(float f, float f2, float f3, float f4) {
        s a = a(p.scale_float_float_float_float);
        a.c = f;
        a.d = f2;
        a.e = f3;
        a.f = f4;
