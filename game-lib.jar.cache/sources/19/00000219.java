...
public class j extends com.corrodinggames.rts.game.units.custom.a.a {
    ...
    public static void a(com.corrodinggames.rts.game.units.custom.l lVar, ab abVar, String str, String str2, com.corrodinggames.rts.game.units.custom.a.d dVar, String str3, boolean z) {
        ...
        LogicBoolean a2 = abVar.a(lVar, str, str2 + "switchToTeam", (LogicBoolean) null, LogicBoolean.ReturnType.number);
        ...
        u a3 = abVar.a(lVar, str, str2 + "addActionCooldownApplyToActions", (u) null);
        ai a4 = abVar.a(str, str2 + "offsetSelfAbsolute", (ai) null);
        ...
        if (floatValue3 > 0.0f || floatValue2 > 0.0f || booleanValue5 || floatValue >= 0.0f || a4 != null || booleanValue6 || booleanValue7) {
            j jVar7 = new j();
    ...
    public boolean a(com.corrodinggames.rts.game.units.custom.j jVar, s sVar, PointF pointF, am amVar, int i) {
        ...
        if (this.d != null && (k = PlayerData.k((int) this.d.readNumber(jVar))) != null) {
            jVar.e(k);
        }
        if (this.e != null) {
        ...
        if (this.o != null) {
            jVar.b(jVar.eo + this.o.f675a, jVar.ep + this.o.b);
            jVar.eq += this.o.c;
            jVar.cK = true;
            return true;
        }
