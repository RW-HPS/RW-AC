...
public abstract class o extends bq {
    ...
    public boolean c(float f, float f2) {
        float a = com.corrodinggames.rts.gameFramework.f.a(this.S, this.T, f, f2);
        float f3 = this.U;
        if (a < f3 * f3) {
            return true;
        }
    ...
    public boolean b(am amVar) {
        float a = com.corrodinggames.rts.gameFramework.f.a(this.S, this.T, amVar.eo, amVar.ep);
        ...
        for (int i = 0; i < 15; i++) {
            ...
            if (this instanceof i) {
                ...
                if (arVar != null) {
                    ...
                    if (yVar != null && c2 > 1) {
                        int i2 = -1;
                        int rand = com.corrodinggames.rts.gameFramework.f.rand(0, c2 - 1);
                        am[] a = am.bE.a();
                        int size = am.bE.size();
                        for (int i3 = 0; i3 < size; i3++) {
                            am amVar = a[i3];
                            if (amVar.bX == this.R && iVar.a(amVar) && amVar.bT() && this.R.i(amVar) && amVar.mo1r() == arVar) {
                                i2++;
                                if (i2 == rand) {
                                    float f2 = amVar.eo;
                                    float f3 = amVar.ep;
                                    float f4 = f2;
                                    float f5 = f3;
                                    if (com.corrodinggames.rts.gameFramework.f.rand(0, 1) == 0) {
