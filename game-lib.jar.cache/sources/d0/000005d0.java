...
public class a {
    ...
    public boolean m;
    public int p;
    public com.corrodinggames.rts.game.maps.a t;
    public bp v;
    public float w;
    public float x;
    public PlayerData y;
    ...
    public int a(String str, int i) {
        ...
        try {
            ...
            throw f(str + ": Unexpected integer value:'" + a + "'");
        }
    }
    ...
    public float a(String str, float f) {
        ...
        try {
            ...
            throw f(str + ": Unexpected float value:'" + a + "'");
        }
    }
    ...
    public Boolean e(String str) {
        ...
        throw f(str + ": Unexpected boolean value:'" + a + "'");
    }
    ...
    public void g(String str) {
        GameNetEngine.g("MapTrigger-Error (" + this.a + " id:" + this.b + " type:" + this.g + "): " + str);
    }

    public void h(String str) {
        GameEngine.m5e("MapTrigger-Debug (" + this.b + " type:" + this.g + "): " + str);
    }
