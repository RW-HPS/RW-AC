...
public class f {
    ...
    public void a(l lVar) {
        ...
        while (it.hasNext()) {
            c cVar = (c) it.next();
            if (cVar.f281a == d.legX || cVar.f281a == d.legY || cVar.f281a == d.legHeight || cVar.f281a == d.legDir || cVar.f281a == d.legAlpha) {
                boolean z = false;
                ba[] baVarArr = lVar.ax;
                ...
                if (!z) {
                    throw new bo("Cannot find leg:" + cVar.c + " for animation:" + this.f299a);
                }
            }
            if (cVar.b < 0) {
                throw new bo("Cannot find target for:" + cVar.c + " for animation:" + this.f299a);
            }
        }
    }
    ...
    public void a(l lVar, com.corrodinggames.rts.gameFramework.utility.ab abVar, String str, String str2) {
        ...
        if (b != null) {
            for (String str4 : b.split(",")) {
                ...
                if (!trim.equals(VariableScope.nullOrMissingString)) {
                    n a3 = n.a(trim);
                    if (a3 == null) {
                        throw new bo("Unknown action type: " + trim + " on animation:" + this.f299a);
                    }
                    if (lVar.a(a3) != null) {
                        throw new bo("Cannot add action: " + trim + " to:" + this.f299a + " it already exists on:" + a2.f299a);
                    }
                    this.p.add(a3);
                }
            }
        ...
        if (this.c != -1 && this.c < this.b) {
            throw new RuntimeException("animationEnd cannot before animationStart on animation:" + this.f299a);
        }
        ...
        Float a4 = abVar.a(str, str2 + "speed", (Float) null);
        if (a4 != null) {
        ...
        while (it.hasNext()) {
            ...
            if (0 == 0) {
                if (z) {
                    throw new bo("Cannot mix new (" + str5 + ") and old style (" + str3 + ") animations on:" + this.f299a);
                }
        ...
        while (it2.hasNext()) {
            ...
            if (cVar3.e.length > 0) {
                this.o = true;
                if (cVar3.f281a != d.frame && cVar3.f281a != d.scale) {
                    this.m = true;
                }
                mVar.add(cVar3);
            }
    ...
    public c a(String str, String str2) {
        ...
        if (str2.startsWith("leg") || str2.startsWith("arm")) {
            ...
            if (str.equalsIgnoreCase("x")) {
                ...
                throw new bo("Unknown leg/arm animation type:" + str + " on animation:" + this.f299a);
            }
            ...
            if (str.equalsIgnoreCase("x")) {
                ...
                throw new bo("Unknown turret animation type:" + str + " on animation:" + this.f299a);
            }
            ...
            if (str.equalsIgnoreCase("scale")) {
                ...
                throw new bo("Unknown body animation type:" + str + " on animation:" + this.f299a);
            }
            ...
            throw new bo("Unknown animation target:" + str2 + " on animation:" + this.f299a);
        }
        Iterator it = this.l.iterator();
        while (it.hasNext()) {
            c cVar = (c) it.next();
            if (cVar.f281a == dVar && str2.equals(cVar.c)) {
                return cVar;
            }
        }
        c cVar2 = new c();
    ...
    public void a(l lVar, com.corrodinggames.rts.gameFramework.utility.ab abVar, String str, String str2, String str3) {
        ...
        try {
            float a2 = com.corrodinggames.rts.gameFramework.utility.ab.a(substring, false, str, str3);
