...
public class RWBasicGame extends BasicGame {
    ...
    public boolean closeRequested() {
        if (!this.i && !com.corrodinggames.rts.a.a.a() && this.c != null && !this.c.isFullscreen()) {
    ...
    public void init(GameContainer gameContainer) {
        ...
        this.m = e.b(R.drawable.logo, true);
        this.n = e.b(R.drawable.pointer, true);
    ...
    public void a() {
        ...
        if (this.f758a.isVSyncRequested() != this.e.settingsEngine.renderVsync) {
            try {
                this.f758a.setVSync(this.e.settingsEngine.renderVsync);
            } catch (OpenGLException e) {
                GameEngine.a("Error while changing vsync setting", (Throwable) e);
            }
        }
        if (this.e.settingsEngine.highRefreshRate) {
            this.f758a.setTargetFrameRate(300);
        } else {
            this.f758a.setTargetFrameRate(120);
        }
        boolean z = false;
        ...
        if (z != this.v) {
            GameEngine.m2e("Grabbing mouse:" + z);
            this.v = z;
            if (!this.u) {
                this.f758a.setMouseGrabbed(this.v);
            }
            if (this.v) {
            }
            if (!this.v) {
        ...
        this.f758a.setSmoothDeltas(this.e.settingsEngine.renderSmoothDelta);
    ...
    public void c() {
        ...
        this.b.h();
        if (GameEngine.aI) {
            GameEngine.m2e("switching to sandbox");
    ...
    public void a(d dVar) {
        ...
        this.f.f742a = this.f758a.getWidth();
        this.f.b = this.f758a.getHeight();
        this.e.b(this.f.f742a, this.f.b);
    ...
    public int a(int i) {
        ...
        GameEngine.m2e("Unknown mouse button:" + i);
        return 0;
    }
    ...
    public void a(int i, int i2, boolean z) {
        ...
        int i4;
        if (this.y) {
            GameEngine.m2e("mouseGrab:m:" + z + ",newX:" + i + ",newY:" + i2);
        }
        if (!this.v) {
            this.w = (int) (i / this.P);
        ...
        GameEngine.m2e("processMouseGrab gameView==null");
    }
    ...
    public void mousePressed(int i, int i2, int i3) {
        ...
        } else if (this.f != null && (a2 = a(i)) != 0) {
            this.f.d.a(this.w, this.x, true, a2);
        }
    }
    ...
    public void mouseReleased(int i, int i2, int i3) {
        ...
        if (d()) {
            ...
            this.f.d.a(this.w, this.x, false, a2);
        }
    }
    ...
    public void keyPressed(int i, char c) {
        a(i, true);
        if (this.b.i == null) {
            GameEngine.m2e("keyPressed: guiEngine==null");
        } else {
            this.b.i.a(i, c);
        }
    }
    ...
    public void g() {
        ...
        try {
            ...
            if (z) {
                ...
                if (str == null) {
                    GameEngine.m2e("fullScreenResolutionString is null");
                    str = "native";
                }
            ...
            if (z) {
                GameEngine.m2e("screen: " + this.c.getScreenWidth() + ", " + this.c.getScreenHeight());
                GameEngine.m2e("container: " + this.f758a.getWidth() + ", " + this.f758a.getHeight());
                if (z2) {
            ...
            if (this.f != null) {
                ...
                GameEngine.m2e("setResolution: gameView=null");
            }
            if (this.e != null) {
                this.e.b(i5, i6);
                this.e.X();
            } else {
                GameEngine.m2e("setResolution: game=null");
            }
            if (this.b != null && this.b.p != null) {
                this.b.p.setDimensionsWrap(i7, i8);
            } else {
                GameEngine.m2e("setResolution: main.libRocket=null");
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public void a(String str, boolean z) {
        ...
        if (!str.startsWith("Loading units ")) {
            GameEngine.m2e("--Now loading:" + str);
            z2 = false;
        }
        if (z) {
            this.N = this.M;
        ...
        Graphics a2 = this.c.a();
        a((GameContainer) this.c, a2);
        this.c.a(a2);
    }
        ...
        if (!this.r) {
            ...
            if (this.b.u) {
                ...
                if (this.b.v > 2) {
                    this.b.u = false;
                    this.b.v = 0;
                    GameEngine.m2e("Saving settings (queued)");
    ...
    public void a(Graphics graphics, boolean z) {
        ...
        try {
            try {
                GameEngine.m2e("Saving screenshot");
                    ...
                    new Thread(new Runnable() { // from class: com.corrodinggames.rts.java.u.1
                        ...
                        public void run() {
                            try {
                                ...
                                GameEngine.m2e("Screenshot saved: " + str);
                            } catch (Exception e) {
                                e.printStackTrace();
                ...
                int i3 = (int) (dVar.f742a * 2.0f);
                int i4 = (int) (dVar.b * 2.0f);
                y yVar = this.e.bO;
                this.Y.a(yVar, i3, i4, 0);
                com.corrodinggames.rts.game.i iVar = (com.corrodinggames.rts.game.i) this.e;
                ...
                try {
                    ...
                    iVar.b(this.Y);
                    this.e.cS = z2;
                    yVar.a(this.Y.f162a, new File(str2));
