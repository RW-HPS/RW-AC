...
public class i extends o {
        ...
        for (int i4 = i2 - i; i4 <= i2 + i; i4++) {
            for (int i5 = i3 - i; i5 <= i3 + i; i5++) {
                if (gameEngine.bL.c(i4, i5) && (e = gameEngine.bL.e(i4, i5)) != null && e.i) {
                    ...
                    if (b != null && (b instanceof y) && !((y) b).r().p()) {
                        z = true;
                    }
                    if (z) {
    ...
    public as c() {
        ...
        while (it.hasNext()) {
            ...
            if (asVar2.j() && b(asVar2)) {
                int a3 = this.R.a(asVar2, b.include);
                int c = c(asVar2);
                boolean z = false;
                ...
                if (asVar2 == ar.landFactory && (a3 < 5 || a2 == 0)) {
                    if (a3 == 0) {
                        f2 = 0.8f;
                    } else if (c < 2) {
                        f2 = 0.46f / (a3 + (c * 2));
                ...
                if (asVar2 == ar.seaFactory && this.R.ah() && (a3 < 5 || a2 == 0)) {
                    if (a3 == 0) {
                        f2 = 0.3f;
                    } else if (c < 1) {
                        f2 = 0.1f / (a3 + (c * 2));
                ...
                if (asVar2 == ar.airFactory && (a3 < 5 || a2 == 0)) {
                    if (a3 == 0) {
                        f2 = 0.48f;
                    } else if (c < 2) {
                        f2 = 0.29f / (a3 + c);
                ...
                if (asVar2 == ar.fabricator && this.R.o > 2000.0d && c < 5) {
                    if (a3 == 0) {
                        f2 = 0.11f;
                    } else {
                        f2 = 0.07f / ((0.2f * a3) + c);
                ...
                if (asVar2 == ar.AntiNukeLaucher && ((!gameEngine.O() || !gameEngine.bX.gameMapData.i) && this.R.o > 2200.0d && a3 < 4)) {
                    if (a3 == 0) {
                        f2 = 0.06f;
                    } else if (c < 1) {
                        f2 = 0.05f / (a3 + (c * 2));
                ...
                if (z) {
                    ...
                    if (!lVar2.fw && ((a3 < lVar2.fx || lVar2.fx == -1) && (c < lVar2.fy || lVar2.fy == -1))) {
                        f2 = lVar2.fz;
                        if (c < lVar2.fA) {
                            f2 = lVar2.fB;
                        }
    ...
    private y a(am amVar, PointF pointF, boolean z) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (amVar2.bX == this.R && a(amVar2) && amVar2.cN == null) {
                as r = amVar2.r();
                if (r.n() && (amVar2 instanceof y) && this.R.i(amVar2)) {
                    y yVar2 = (y) amVar2;
                    if (f.b(yVar2) && ((!z || yVar2.I()) && (amVar == null || yVar2.h(amVar, true)))) {
                        boolean z2 = false;
                        if (r instanceof com.corrodinggames.rts.game.units.custom.l) {
                            com.corrodinggames.rts.game.units.custom.l lVar = (com.corrodinggames.rts.game.units.custom.l) r;
    ...
    private boolean g(as asVar) {
        ...
        if (e == null || (a2 = a(asVar, e, false)) == null) {
            return false;
        }
    ...
    */
    ...
    public void q() {
        ...
        if (this.r.size() != 0 && this.B != null) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                am amVar = a2[i2];
                if (amVar.bX == this.R && a(amVar) && amVar.cN == null && amVar.r().n() && (amVar instanceof y) && this.R.i(amVar) && com.corrodinggames.rts.gameFramework.f.c(0.0f, 1.0f) <= 0.3d && (ar = (yVar = (y) amVar).ar()) != null && ar.d() == av.reclaim && (i = ar.i()) != null && i.g() > 0.0f && !this.B.c(i.cM())) {
                    a(yVar, r());
                    return;
                }
            }
    ...
    public void s() {
        ...
        if (A != null) {
            ...
            y a2 = a((as) null, this.x, true);
            if (a2 != null && a2.a(A) && A.e(a2) < 2) {
                SyncPacket a3 = gameEngine.cf.a(this.R);
                a3.a(a2);
                a3.b(A);
            }
    ...
    public void b(float f) {
        ...
        if (i < 2 && this.i == 0.0f) {
            this.i = 300.0f;
            int a2 = this.R.a(this.R.bz, b.include);
            if (!this.s || a2 <= 2) {
    ...
    public void v() {
        ...
        if ((this.R.a(1300.0d) && this.d >= 1.0f) || (this.R.a(300.0d) && this.d >= 3.0f)) {
            ...
            if (this.d >= 1.0f && ai && this.m == 0.0f) {
                int a3 = this.R.a(this.R.bx, b.include);
                int a4 = a3 + this.R.a(this.R.by, b.include);
                int ao = this.R.ao();
                if ((this.R.a(1700.0d) || ao > 10 || (this.R.bl == 0 && ao >= 1 && a3 == 0)) && (a4 < 3 || (ao > 20 && a4 < 5))) {
                    if (aj && a4 < 2) {
