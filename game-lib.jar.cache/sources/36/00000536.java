...
public class GameInputStream {
    ...
    public PlayerData r() {
        ...
        PlayerData playerData = PlayerData.getPlayerData(readByte);
        if (playerData == null) {
    ...
    public PlayerData s() {
        return PlayerData.getPlayerData(this.useStream.readByte());
    }
    ...
    public void a(String str, boolean z, boolean z2) {
        if (this.b < 11) {
            GameEngine.m5e("Skipping start block:" + str);
            return;
        }
        String a = a(z, z2);
        if (!a.equals(str)) {
            GameEngine.b("InputNetStream:endBlock", "Name does not match: expected:" + str + " , got:" + a);
        }
    }
    ...
    public String a(boolean z, boolean z2) {
        if (this.b < 11) {
            GameEngine.m5e("Skipping start block: startBlockAndGetName()");
            return "<skipped>";
        }
        String readUTF = this.useStream.readUTF();
    ...
    public void endBlock(String str) {
        if (this.b < 11) {
            GameEngine.m5e("Skipping end block:" + str);
            return;
        }
        l lVar = (l) this.g.removeLast();
        if (!lVar.a.equals(str)) {
            GameEngine.b("InputNetStream:endBlock", "Name does not match: expected" + str + " ," + lVar.a);
        }
        if (this.g.isEmpty()) {
            this.useStream = this.dataStream;
        } else {
