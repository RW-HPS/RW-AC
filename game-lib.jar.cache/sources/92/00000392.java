...
public abstract class d extends y {
    ...
    public static void dt() {
        p = GameEngine.getGameEngine().bO.a(R.drawable.unit_icon_building);
        q = PlayerData.a(p);
    }
    ...
    public static boolean a(y yVar, as asVar, ao aoVar, int i, int i2, int i3) {
        ...
        boolean z = false;
        if (bVar.E && gameEngine.bs.N != null) {
            if (!bVar.G && gameEngine.bs.N[i][i2] == 10) {
                return false;
            }
            z = gameEngine.bs.N[i][i2] >= 5;
        }
        if (a(yVar, asVar, aoVar, i, i2, z)) {
            if (asVar.p()) {
                com.corrodinggames.rts.game.b.g e = bVar.e(i, i2);
                if (e != null && e.i) {
                    return true;
                }
                return false;
            } else if (com.corrodinggames.rts.gameFramework.d.a.a(gameEngine.bs, i, i2, i3)) {
                return false;
            } else {
                return true;
            }
    ...
    public static String a(y yVar, as asVar, ao aoVar, int i, int i2, boolean z, PlayerData playerData) {
        ...
        be q2 = asVar.q();
        if (q2 != null && (a2 = q2.a(yVar, i, i2)) != null) {
            return a2;
        }
        ...
        com.corrodinggames.rts.game.b.g e = gameEngine.bL.e(i, i2);
        if (e != null && e.i) {
            if (asVar.p()) {
                return null;
            }
    ...
    public Paint f() {
        ...
        if (this.cm < 1.0f) {
            a2 = Color.a((int) (40.0f + (this.cm * 200.0f)), 140, 255, 140);
            porterDuffColorFilter = aX;
        } else {
            a2 = Color.a(255, 255, 255, 255);
        }
        if (this.cp) {
            if (this.cs) {
                a2 = Color.a(200, 20, 255, 20);
                porterDuffColorFilter = aY;
            }
            if (this.ct) {
                a2 = Color.a(200, 255, 20, 20);
                porterDuffColorFilter = aZ;
            }
            if (this.cq) {
                a2 = Color.a(70, 70, 70, 245);
                porterDuffColorFilter = ba;
                if (this.ct) {
                    a2 = Color.a(70, 255, 20, 20);
                    porterDuffColorFilter = aZ;
                }
            }
            if (this.cr) {
                a2 = Color.a(150, 100, 100, 100);
            }
        }
        ...
        return a(a2, porterDuffColorFilter, z);
    }
