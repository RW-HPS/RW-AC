...
public class am {
    ...
    public ArrayList d() {
        ...
        for (String str : MusicType.starting.b()) {
            arrayList.add(str);
        }
        for (String str2 : MusicType.buildup.b()) {
            arrayList.add(str2);
        }
        for (String str3 : MusicType.starting.b()) {
            arrayList.add(str3);
        }
        return arrayList;
    }

    public String a(MusicType musicType) {
        return a(musicType, musicType);
    }

    public String a(MusicType musicType, MusicType musicType2) {
        MusicType musicType3;
        GameEngine.getGameEngine();
        if (f.c(musicType.b().length + musicType2.b().length) < musicType.b().length) {
            musicType3 = musicType;
        } else {
            musicType3 = musicType2;
        }
        String[] b = musicType3.b();
        return musicType3.a(b[f.c(b.length)]);
    }
    ...
    public void c(float f) {
        ...
        if (this.n) {
            ...
            this.q += f;
            if (this.q > 3600.0f) {
                GameEngine.m5e("Next music track, timer:" + this.q);
                z = true;
                this.q = 0.0f;
            }
        }
        if (this.y) {
            com.corrodinggames.rts.gameFramework.mod.b z2 = InterfaceEngine.z();
            if (z2 != null && z2.N) {
                z = true;
            }
            this.y = false;
        ...
        if (z || this.s) {
            ...
            String str = this.t;
            if (this.s) {
                GameEngine.m5e("Next music track requested");
                this.s = false;
                this.q = 0.0f;
                this.t = null;
            }
            ...
            if (str != null) {
                ...
                if (str2 == null) {
                    GameEngine.m5e("Failed to find requested music: " + str);
                }
            }
            com.corrodinggames.rts.gameFramework.mod.b z5 = InterfaceEngine.z();
            if (str2 == null && z5 != null && z5.P < 10 && z5.N) {
                ArrayList q = z5.q();
                if (q.size() > 0) {
                    z4 = true;
                    bVar = z5;
                    str2 = (String) q.get(f.rand(0, q.size() - 1));
                    ...
                    GameEngine.m5e("Playing music from mod:" + z5.a() + " - '" + str2 + "'");
                }
            }
            if (str2 == null) {
                if (this.x) {
                    str2 = a(MusicType.starting);
                } else {
                    str2 = a(MusicType.buildup, MusicType.starting);
                }
                if (z3 || this.I.contains(str2)) {
            ...
            if (!str2.equals(this.m)) {
                ...
                GameEngine.m5e("Same music found");
            }
        }
        if (this.C || this.o) {
            boolean c = a.c();
