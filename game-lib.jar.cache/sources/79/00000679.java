...
public class b extends c {
    ...
    public boolean a() {
        ...
        af a2 = ae.a(this.f72a);
        if (a2 != null) {
            fileInputStream = a2.b(this.f72a, true);
            if (fileInputStream == null) {
                GameEngine.g("Failed to open zipped file: " + this.f72a);
                return false;
            }
        } else {
            try {
                fileInputStream = new FileInputStream(this.f72a);
            } catch (IOException e) {
                e.printStackTrace();
                return false;
            }
        ...
        try {
            ...
            GameEngine.a("Exception loading image: " + this.f72a, (Throwable) e2);
            this.h = e.s.C();
            this.i = true;
            ...
            e4.printStackTrace();
            GameEngine.a("Exception loading image: " + this.f72a, (Throwable) e4);
            this.h = e.s.C();
            this.i = true;
        }
        try {
            ...
            if (this.c) {
                if (this.width > 500 || this.height > 500) {
                    GameEngine.m2e("Map thumbnail is too large. Size:(" + this.width + "," + this.height + ") (max:500 pixels)");
                    this.h = e.t.C();
                    this.i = true;
                    this.width = this.h.getWidth();
                    this.height = this.h.getHeight();
