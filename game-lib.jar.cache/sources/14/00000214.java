...
public class e extends com.corrodinggames.rts.game.units.custom.a.a {
    ...
    public static void a(com.corrodinggames.rts.game.units.custom.l lVar, ab abVar, String str, String str2, com.corrodinggames.rts.game.units.custom.a.d dVar, String str3, boolean z) {
        bp a2 = bp.a(lVar, abVar, str, str2 + "attachments_addNewUnits");
        ...
        if (!a2.b() || intValue != 0 || booleanValue3 || booleanValue || booleanValue2) {
            e eVar = new e();
            eVar.f221a = a2;
    ...
    public boolean a(com.corrodinggames.rts.game.units.custom.j jVar, s sVar, PointF pointF, am amVar, int i) {
            ...
            while (true) {
                ...
                if (amVar2 != null) {
                    ...
                    if (!(amVar2 instanceof y)) {
                        GameEngine.m328e("Failed to deattach unit:" + amVar2.r().i() + " is not an OrderableUnit");
                    } else {
                        y yVar = (y) amVar2;
                        if (this.e) {
        ...
        if (this.f221a != null) {
            ...
            this.f221a.a(mVar, jVar.bX, (am) jVar, true);
            Iterator it3 = mVar.iterator();
            while (it3.hasNext()) {
                am amVar4 = (am) it3.next();
                boolean z3 = false;
                if (!(amVar4 instanceof y)) {
                    GameEngine.m328e("Failed to attach unit:" + amVar4.r().i() + " is not an OrderableUnit");
                } else {
                    y yVar2 = (y) amVar4;
                    if (this.b != null) {
