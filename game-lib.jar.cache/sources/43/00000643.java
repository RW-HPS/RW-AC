...
public class d {
    ...
    public d(boolean z, int i) {
        this.c = z;
        this.f713a = new int[i];
    }

    public d(d dVar) {
        this.c = dVar.c;
        this.b = dVar.b;
        this.f713a = new int[this.b];
        System.arraycopy(dVar.f713a, 0, this.f713a, 0, this.b);
    }
    ...
    protected int[] d(int i) {
        int[] iArr = new int[i];
        System.arraycopy(this.f713a, 0, iArr, 0, Math.min(this.b, iArr.length));
        this.f713a = iArr;
        return iArr;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (this.c && (obj instanceof d)) {
            ...
            if (dVar.c && (i = this.b) == dVar.b) {
                int[] iArr = this.f713a;
                int[] iArr2 = dVar.f713a;
                for (int i2 = 0; i2 < i; i2++) {
                    if (this.f713a[i2] != dVar.f713a[i2]) {
                        return false;
                    }
                }
                return true;
