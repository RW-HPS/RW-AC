...
public class CheckSumData {
    ...
    public void b() {
        ...
        for (int i = 0; i < PlayerData.c; i++) {
            ...
            if (playerData != null) {
                this.i.b += (int) playerData.credits;
                if (i == 0) {
                    this.m.b += (int) playerData.credits;
                }
                if (i == 1) {
                    this.n.b += (int) playerData.credits;
                }
                if (i == 2) {
                    this.o.b += (int) playerData.credits;
                }
                this.k.b += playerData.w();
                this.l.b += i + (playerData.x * 100) + (playerData.team * 1000) + ((playerData.w ? i : 0) * 10000);
            }
        }
    }
}