...
public class ai extends v {
    com.corrodinggames.rts.gameFramework.unitAction.e b;
    int c;
    int d;
    float e;
    float f;
    ...
    boolean r;
    Rect u;
    static com.corrodinggames.rts.gameFramework.unitAction.e[] a = new com.corrodinggames.rts.gameFramework.unitAction.e[2];
    static Point s = new Point();
    public static aj t = new aj();

    public static void b() {
        a[0] = GameEngine.getGameEngine().bO.a(AssetsID.drawable.fire);
    }
    ...
    public void f() {
        ...
        com.corrodinggames.rts.game.maps.g a2 = gameEngine.bL.u.a(i, i2);
        boolean z = false;
