...
public final class c {
    ...
    public e a(h hVar) {
        ...
        e a = a(true, (h) null);
        if (a == null && (hVar == h.critical || hVar == h.veryhigh)) {
            a = a(false, h.high);
        }
        if (a != null) {
            if (!a.o) {
    ...
    public void a(float f2, float f3, float f4, float f5, float f6) {
        for (int i = 0; i < 7; i++) {
            e b = b(f2 + f.c(-20.0f, 20.0f), f3 + f.c(-20.0f, 20.0f), f4);
            if (b != null) {
                b.U = f5 + f.c(0.0f, f6);
                b.aj = f.c(0.3f, 0.6f);
            }
    ...
    public e a(float f2, float f3, float f4, float f5, float f6, float f7) {
        ...
        if (!gameEngine.bL.a(f2, f3, gameEngine.playerTeam) && !gameEngine.bL.a(f5, f6, gameEngine.playerTeam)) {
            return null;
        }
    ...
    public e b(float f2, float f3, float f4, float f5) {
        ...
        if (b != null) {
            ...
            b.W = 80.0f;
            b.V = b.W;
            b.Y = f.c(-180.0f, 180.0f);
            b.G = f.c(0.6f, 0.8f);
            b.F = 1.5f;
            b.P = (f.k(f5) * 0.13f * f.c(1.0f, 1.5f)) + f.c(-0.01f, 0.01f);
            b.Q = (f.j(f5) * 0.13f * f.c(1.0f, 1.5f)) + f.c(-0.01f, 0.01f);
        }
        return b;
    }
    ...
    public void a(float f2, float f3, float f4, int i, float f5, float f6, float f7) {
        ...
        for (int i2 = -180; i2 < 180; i2 += 45) {
            float f8 = f7 + i2;
            e b = b(f2 + (f.k(f8) * (-5.0f)), f3 + (f.j(f8) * (-5.0f)), 0.0f, f8);
            if (b != null) {
                b.ar = (short) 2;
                b.s = true;
                b.t = 7.0f;
    ...
    public e b(float f2, float f3, float f4, float f5, float f6) {
        ...
        if (b != null) {
            ...
            b.aq = 12;
            b.ap = f.rand(0, 7);
            b.V = f.c(400.0f, 800.0f);
            b.W = b.V - 150.0f;
            b.r = true;
            float c = f.c(0.6f, 1.0f);
            b.G = c;
            b.F = c;
            b.ar = (short) 2;
            b.v = true;
            b.as = true;
            float c2 = f.c(-180.0f, 180.0f);
            float c3 = f.c(0.4f, 1.2f) * f5;
            b.P = f.k(c2) * c3;
            b.Q = f.j(c2) * c3;
            b.R = f.c(0.6f, 2.7f) * f6;
            b.Y = f.c(-180.0f, 180.0f);
            b.K += 1.0f;
        }
        return b;
    ...
    public e f(float f2, float f3, float f4) {
        ...
        if (b != null) {
            ...
            b.G = 0.5f;
            b.G = 1.0f;
            int rand = f.rand(0, 100);
            if (rand > 80) {
                b.aj = f.c(0.1f, 0.15f);
                b.ag = 15;
            } else if (rand > 60) {
                b.aj = f.c(0.06f, 0.16f);
                b.ah = true;
                b.ag = 6;
                b.r = true;
            } else {
    ...
    public e b(float f2, float f3, float f4, d dVar, boolean z, h hVar) {
        ...
        if (!z && gameEngine.bL != null && !gameEngine.bL.a(f2, f3, gameEngine.playerTeam)) {
            return null;
        }
    ...
    public void a(Context context) {
        ...
        gVar.f = 26;
        gVar.g = 26;
        gVar.i = gameEngine.bO.a(AssetsID.drawable.effects, true);
        gVar.a = "effects";
        gVar.a();
        s[0] = gVar;
        g gVar2 = new g();
        ...
        gVar2.f = 40;
        gVar2.g = 41;
        gVar2.i = gameEngine.bO.a(AssetsID.drawable.explode_big, true);
        gVar2.a = "explode_big";
        s[1] = gVar2;
        g gVar3 = new g();
        gVar3.k = true;
        gVar3.i = gameEngine.bO.a(AssetsID.drawable.light_50, true);
        gVar3.a = "light_50";
        s[2] = gVar3;
        g gVar4 = new g();
        gVar4.b = 20;
        ...
        gVar4.f = 20;
        gVar4.g = 25;
        gVar4.i = gameEngine.bO.a(AssetsID.drawable.flame, true);
        gVar4.a = "flame";
        s[3] = gVar4;
        g gVar5 = new g();
        gVar5.b = 20;
        ...
        gVar5.f = gVar5.b;
        gVar5.g = gVar5.c;
        gVar5.i = gameEngine.bO.a(AssetsID.drawable.dust, true);
        gVar5.a = "dust";
        s[4] = gVar5;
        g gVar6 = new g();
        gVar6.b = 50;
        ...
        gVar6.f = gVar6.b;
        gVar6.g = gVar6.c;
        gVar6.i = gameEngine.bO.a(AssetsID.drawable.smoke_black, true);
        gVar6.a = "smoke_black";
        gVar6.a();
        s[5] = gVar6;
        g gVar7 = new g();
        ...
        gVar7.f = gVar7.b;
        gVar7.g = gVar7.c;
        gVar7.i = gameEngine.bO.a(AssetsID.drawable.shockwave, true);
        gVar7.a = "shockwave";
        s[6] = gVar7;
        g gVar8 = new g();
        gVar8.b = 20;
        ...
        gVar8.f = gVar8.b;
        gVar8.g = gVar8.c;
        gVar8.i = gameEngine.bO.a(AssetsID.drawable.fire, true);
        gVar8.a = "fire";
        s[7] = gVar8;
        g gVar9 = new g();
        gVar9.b = 20;
        ...
        gVar9.f = gVar9.b + 2;
        gVar9.g = gVar9.c;
        gVar9.i = gameEngine.bO.a(AssetsID.drawable.lava_bubble, true);
        gVar9.a = "lava_bubble";
        s[8] = gVar9;
        g gVar10 = new g();
        gVar10.b = 28;
        ...
        gVar10.f = gVar10.b + 1;
        gVar10.g = gVar10.c + 1;
        gVar10.i = gameEngine.bO.a(AssetsID.drawable.effects2, true);
        gVar10.a = "effects2";
        s[9] = gVar10;
        g gVar11 = new g();
        gVar11.b = 20;
        ...
        gVar11.f = 20;
        gVar11.g = 25;
        gVar11.i = gameEngine.bO.a(AssetsID.drawable.plasma_shot, true);
        gVar11.a = "plasma_shot";
        s[10] = gVar11;
        g gVar12 = new g();
        gVar12.b = 104;
        gVar12.c = 104;
        ...
        gVar12.f = gVar12.b;
        gVar12.g = gVar12.c;
        gVar12.i = gameEngine.bO.a(AssetsID.drawable.shockwave_large, true);
        gVar12.a = "shockwave_large";
        s[11] = gVar12;
        g gVar13 = new g();
        gVar13.b = 20;
        gVar13.c = 20;
        ...
        gVar13.f = gVar13.b;
        gVar13.g = gVar13.c;
        gVar13.i = gameEngine.bO.a(AssetsID.drawable.explode_bits, true);
        gVar13.a = "explode_bits";
        gVar13.a();
        s[12] = gVar13;
        g gVar14 = new g();
        gVar14.b = 39;
        ...
        gVar14.f = 40;
        gVar14.g = 41;
        gVar14.i = gameEngine.bO.a(AssetsID.drawable.explode_big2, true);
        gVar14.a = "explode_big2";
        s[13] = gVar14;
        g gVar15 = new g();
        gVar15.b = 20;
        gVar15.c = 20;
        ...
        gVar15.f = gVar15.b;
        gVar15.g = gVar15.c;
        gVar15.i = gameEngine.bO.a(AssetsID.drawable.explode_bits_bug, true);
        gVar15.a = "explode_bits_bug";
        gVar15.a();
        s[14] = gVar15;
        g gVar16 = new g();
        gVar16.b = 20;
        ...
        gVar16.f = gVar16.b;
        gVar16.g = gVar16.c;
        gVar16.i = gameEngine.bO.a(AssetsID.drawable.projectiles, true);
        gVar16.a = "projectiles";
        gVar16.a();
        s[15] = gVar16;
        g gVar17 = new g();
        gVar17.b = 20;
        ...
        gVar17.f = gVar17.b;
        gVar17.g = gVar17.c;
        gVar17.i = gameEngine.bO.a(AssetsID.drawable.projectiles2, true);
        gVar17.a = "projectiles2";
        gVar17.a();
        s[16] = gVar17;
        g gVar18 = new g();
        gVar18.b = 30;
        ...
        gVar18.f = gVar18.b + 1;
        gVar18.g = gVar18.c + 1;
        gVar18.i = gameEngine.bO.a(AssetsID.drawable.effects3, true);
        gVar18.a = "effects3";
        s[17] = gVar18;
        g gVar19 = new g();
        gVar19.b = 50;
        ...
        gVar19.f = gVar19.b;
        gVar19.g = gVar19.c;
        gVar19.i = gameEngine.bO.a(AssetsID.drawable.smoke_white, true);
        gVar19.a = "smoke_white";
        gVar19.a();
        s[18] = gVar19;
        g gVar20 = new g();
        gVar20.b = 56;
        ...
        gVar20.f = gVar20.b;
        gVar20.g = gVar20.c;
        gVar20.i = gameEngine.bO.a(AssetsID.drawable.shockwave2, true);
        gVar20.a = "shockwave2";
        gVar20.a();
        s[19] = gVar20;
        if (GameEngine.av()) {
    ...
    public int a(String str) {
        for (int i = 0; i < s.length; i++) {
            if (s[i] != null) {
                if (s[i].a != null && s[i].a.equalsIgnoreCase(str)) {
                    return i;
                }
    ...
    public void a(float f2) {
        ...
        if (this.x > 10.0f) {
            this.x = 0.0f;
            gameEngine.bL.a(gameEngine.cu + f.rand(0, (int) gameEngine.cA), gameEngine.cv + f.rand(0, (int) gameEngine.cB));
            int i2 = gameEngine.bL.T;
            int i3 = gameEngine.bL.U;
            g d = gameEngine.bL.d(i2, i3);
            if (d != null && d.g && !d.h) {
