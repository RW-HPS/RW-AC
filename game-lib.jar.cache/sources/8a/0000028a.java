...
public final class f {
    ...
    public static void c(f fVar, am amVar) {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            e eVar = (e) a2[i2];
            if (eVar.a.t) {
                amVar.bX.V().d(eVar.a, eVar.b);
            } else {
                amVar.df().d(eVar.a, eVar.b);
            }
        }
    }
    ...
    public static void b(f fVar, am amVar, double d) {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            e eVar = (e) a2[i2];
            if (eVar.a.t) {
                amVar.bX.V().d(eVar.a, eVar.b * d);
            } else {
                amVar.df().d(eVar.a, eVar.b * d);
            }
        }
    }
    ...
    public static void d(f fVar, am amVar) {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            e eVar = (e) a2[i2];
            if (eVar.a.t) {
                amVar.bX.V().b(eVar.a, eVar.b);
            } else {
                amVar.df().b(eVar.a, eVar.b);
            }
        }
    }
    ...
    public static void c(f fVar, am amVar, double d) {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            e eVar = (e) a2[i2];
            if (eVar.a.t) {
                amVar.bX.V().b(eVar.a, eVar.b * d);
            } else {
                amVar.df().b(eVar.a, eVar.b * d);
            }
        }
    }
    ...
    public void a(GameOutputStream gameOutputStream) {
        ...
        gameOutputStream.a((short) this.b.a);
        int i = this.b.a;
        Object[] a2 = this.b.a();
        for (int i2 = 0; i2 < i; i2++) {
            e eVar = (e) a2[i2];
            gameOutputStream.writeString(eVar.a.b);
    ...
    public boolean e(f fVar) {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            e eVar = (e) a2[i2];
            if (!com.corrodinggames.rts.gameFramework.f.b(eVar.b, fVar.a(eVar.a))) {
                return false;
            }
        }
        return true;
    ...
    public boolean f(f fVar) {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            e eVar = (e) a2[i2];
            if (eVar.b > 0.0d && fVar.b(eVar.a) > 0.0d) {
                return true;
            }
        }
        return false;
    ...
    public void e() {
        Collections.sort(this.b, new Comparator() { // from class: com.corrodinggames.rts.game.units.custom.e.f.1
            ...
            public int compare(e eVar, e eVar2) {
                ...
                return Float.compare(eVar.a.x, eVar2.a.x);
            }
        });
    }
}