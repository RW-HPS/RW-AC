...
public class LoadImage extends com.corrodinggames.rts.gameFramework.unitAction.e {
    ...
    public void J() {
        ...
        GameEngine.m2e("Recreating image data from texture: " + a() + " (" + br.a(br.a(a2)) + ")");
    }
    ...
    @Override // com.corrodinggames.rts.gameFramework.unitAction.e
    /* renamed from: h */
    public com.corrodinggames.rts.gameFramework.unitAction.e m7clone() {
    ...
    public void F() {
        ...
        if (this.D) {
            GameEngine.m2e("reloadImage: skipping cloned image:" + this.C);
        } else if (this.C == null) {
            GameEngine.m2e("reloadImage: filepath is null, skipping");
        } else {
            try {
                GameEngine.m2e("reloadImage: reloading:" + this.C);
                if (this.x != null) {
                    this.x.destroy();
                } else {
                    GameEngine.m2e("slickImage==null cannot free");
                }
                K++;
                fileInputStream = new FileInputStream(this.C);
            } catch (IOException e) {
                GameEngine.m2e("reloadImage: failed");
                e.printStackTrace();
    ...
    public void t() {
        ...
        if (this.J == -1) {
            ...
            GameEngine.m2e("reloadImage: '" + this.C + "' reloading current now:" + c);
            F();
            this.J = c;
        }
    }
    ...
    public void G() {
        GameEngine.m2e("SlickBitmapOrTexture: " + a());
        GameEngine.m2e(" className:" + getClass().getSimpleName());
        GameEngine.m2e(" filepath:" + this.C);
        GameEngine.m2e(" slickImage:" + (this.x != null));
        GameEngine.m2e(" cloned:" + this.D);
    }
}