...
public class bn {
    ...
    public static void a(bn bnVar, l lVar, com.corrodinggames.rts.gameFramework.utility.ab abVar, String str) {
        ...
        Float a2 = abVar.a(str, "warmupCallDownRate", (Float) null);
        if (a2 != null) {
            bnVar.o = a2.floatValue();
        }
        Boolean a3 = abVar.a(str, "warmupNoReset", (Boolean) null);
        if (a3 != null) {
            bnVar.s = a3.booleanValue();
        }
        Float a4 = abVar.a(str, "warmupShootDelayTransfer", (Float) null);
        if (a4 != null) {
            bnVar.t = a4.floatValue();
        }
        ...
        Float a5 = abVar.a(str, "energyUsage", (Float) null);
        if (a5 != null) {
            bnVar.u = a5.floatValue();
        }
        bnVar.aI = abVar.b(str, "unloadUpToXUnitsAndGiveAttackOrder", Integer.valueOf(bnVar.aI)).intValue();
        com.corrodinggames.rts.game.units.custom.d.b a6 = com.corrodinggames.rts.game.units.custom.d.b.a(lVar, abVar, str, "resourceUsage", true);
        if (a6 != null && a6.d()) {
            bnVar.v = a6;
            lVar.a(a6);
        }
        ...
        Float a7 = abVar.a(str, "idleDir", (Float) null);
        if (a7 != null) {
            bnVar.j = a7.floatValue();
        }
        Float a8 = abVar.a(str, "idleDirReversing", (Float) null);
        if (a8 != null) {
            bnVar.k = a8.floatValue();
            bnVar.l = true;
        } else if (!bnVar.l) {
            if (bnVar.y != null) {
                bnVar.k = 0.0f;
        ...
        Boolean a9 = abVar.a(str, "canShoot", (Boolean) null);
        Boolean a10 = abVar.a(str, "canAttack", (Boolean) null);
        if (a9 != null && a10 != null) {
        ...
        if (a9 != null) {
            ...
            bnVar.B = a10.booleanValue();
        }
        bnVar.D = bl.a(lVar, abVar.b(str, "shoot_sound", (String) null), bnVar.D);
        Float a11 = abVar.a(str, "shoot_sound_vol", (Float) null);
        if (a11 != null) {
            bnVar.D.a(a11.floatValue());
        }
        ...
        Float a12 = abVar.a(str, "barrelY", (Float) null);
        Float a13 = abVar.a(str, "size", (Float) null);
        ...
        if (bnVar.aj != null) {
            lVar.bE = true;
            lVar.a(com.corrodinggames.rts.game.units.custom.b.k.f262a);
        }
        ...
        com.corrodinggames.rts.gameFramework.m.e a14 = lVar.a(abVar, str, "image");
        if (a14 != null) {
            bnVar.aD = a14;
            boolean z = lVar.s;
            Boolean a15 = abVar.a(str, "image_applyTeamColors", (Boolean) null);
            if (a15 != null) {
                z = a15.booleanValue();
            }
            if (z) {
        ...
        com.corrodinggames.rts.gameFramework.m.e a16 = lVar.a(abVar, str, "chargeEffectImage");
        if (a16 != null) {
            bnVar.aF = a16;
            lVar.fP = true;
        }
