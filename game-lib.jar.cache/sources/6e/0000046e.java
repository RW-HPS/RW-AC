...
public class n implements k {
    ...
    private static String a(int i, String str) {
        ...
        for (String str2 : str.split("\n")) {
            if (!z && str2.contains("version")) {
                ...
                if (!str2.equals(str2)) {
                    GameEngine.m328e("Changing: " + str2 + " to " + str2);
                }
    ...
    private void a(int i, int i2, float f) {
        ...
        q();
        GLES20.glUniform4fv(this.e[2].f438a, 1, b, 0);
        b(this.e, i);
        q();
    }
    ...
    public void c(com.corrodinggames.rts.gameFramework.m.ae aeVar) {
        com.corrodinggames.rts.gameFramework.m.af[] afVarArr;
        for (com.corrodinggames.rts.gameFramework.m.af afVar : aeVar.p) {
            if (afVar.c || afVar.f != null) {
                afVar.c = false;
                if (afVar.b == -1) {
                    afVar.b = GLES20.glGetUniformLocation(aeVar.n, afVar.f625a);
                ...
                if (afVar.f != null) {
                    b a2 = this.l.a(afVar.f.b(), afVar.f);
                    if (afVar.g) {
                        GLES20.glUniform2f(afVar.b, a2.e, a2.f);
                    } else {
                        int a3 = a2.a();
    ...
    public p a(int i, boolean z, boolean z2) {
        GameEngine.m328e("Loading new font size:" + i + " bold:" + z + " unicode:" + z2);
        try {
            p pVar = new p(this);
            pVar.f437a = i;
            pVar.b = z;
    ...
    public void a(String str, float f, float f2, Paint paint) {
        ...
        r();
        int e = paint.e();
        float a2 = Color.a(e) * 0.003921569f;
        float b = Color.b(e) * 0.003921569f * a2;
        float c = Color.c(e) * 0.003921569f * a2;
        float d = Color.d(e) * 0.003921569f * a2;
        float k2 = paint.k();
        if (k2 != pVar.f437a) {
        }
        bVar.a(b, c, d, a2, this.d);
        bVar.a(k2 / pVar.f437a);
        r();
