...
public class g {
    ...
    private void e(SteamPublishedFileID steamPublishedFileID) {
        GameEngine.m2e("Adding request for workshop details: " + steamPublishedFileID);
    ...
    public SteamPublicData_2 a(SteamPublishedFileID steamPublishedFileID) {
        ...
        if (steamPublicData_2 == null) {
            GameEngine.m2e("New ItemInfo: " + steamPublishedFileID);
            steamPublicData_2 = new SteamPublicData_2();
            steamPublicData_2.f736a = steamPublishedFileID;
    ...
    public String b(SteamPublishedFileID steamPublishedFileID) {
        SteamPublicData_2 a2 = a(steamPublishedFileID);
        if (a2.b == 0 && !a2.c) {
            a2.b = System.currentTimeMillis();
            e(steamPublishedFileID);
        }
        if (a2.c) {
            GameEngine.m2e("Got data for: " + steamPublishedFileID + " - " + a2.d);
            return a2.d;
        }
        GameEngine.m2e("No data for: " + steamPublishedFileID);
        return null;
    }
    ...
    public SteamPublicData_1 c(SteamPublishedFileID steamPublishedFileID) {
        ...
        while (it.hasNext()) {
            ...
            if (steamPublicData_1.f737a.equals(steamPublishedFileID)) {
    ...
    public void c() {
        ...
        if (numSubscribedItems != this.k) {
            GameEngine.m2e("Number of subscribed items changed from: " + this.k + " to: " + numSubscribedItems);
    ...
    public void d() {
        ...
        SteamAPI.runCallbacks();
        GameEngine.m2e("--------------");
        GameEngine.m2e("Steam: loadWorkshopMods");
        int numSubscribedItems = this.d.getNumSubscribedItems();
        this.k = numSubscribedItems;
        ...
        for (SteamPublishedFileID steamPublishedFileID : steamPublishedFileIDArr) {
            ...
            GameEngine.m2e("Found workshop item " + d + " with state: " + str + VariableScope.nullOrMissingString);
            String str2 = "sw" + d;
            ...
            String str5 = null;
            if (!z5) {
                GameEngine.m2e("Skipping: " + d + " as it is not subscribed");
            } else {
                if (z) {
                    ...
                    GameEngine.m2e(" Installed at: " + str4);
                } else {
                    GameEngine.m2e(" Not installed");
                    str5 = "Not installed.";
                    if (z4) {
                        str5 = "Update needed..";
                    }
                ...
                b a2 = gameEngine.bZ.a(str2, str2, str4, str2, true, true, false, i);
                if (a2.s == null) {
                    a2.t = str3;
                }
                if (str5 == null && z4) {
                ...
                a2.T = str5;
                if ((!z || z4) && (!z2 || z3)) {
                    GameEngine.m2e("Queuing download on: " + steamPublishedFileID);
