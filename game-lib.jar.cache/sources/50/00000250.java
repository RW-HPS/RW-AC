...
public class ay {
    ...
    public ay(az azVar) {
        ...
        this.life = 200.0f;
        this.priority = com.corrodinggames.rts.gameFramework.d.h.high;
        this.scaleTo = 1.0f;
        this.scaleFrom = 1.0f;
        this.alpha = 1.0f;
        this.color = -1;
    ...
    public com.corrodinggames.rts.gameFramework.d.e a(float f, float f2, float f3, float f4, com.corrodinggames.rts.gameFramework.w wVar, int i, short s) {
        ...
        com.corrodinggames.rts.gameFramework.d.e eVar;
        ...
        if (this.spawnChance < 1.0f && com.corrodinggames.rts.gameFramework.f.c(0.0f, 1.0f) > this.spawnChance) {
            ...
            if (this.builtInEffect == az.small) {
                ...
                com.corrodinggames.rts.gameFramework.d.f.a(f, f2).j = -6684775;
                com.corrodinggames.rts.gameFramework.d.f b = com.corrodinggames.rts.gameFramework.d.f.b(f, f2);
                b.f472a = 500.0f;
                b.j = -6684775;
                gameEngine.bR.b(com.corrodinggames.rts.gameFramework.d.h.critical);
                com.corrodinggames.rts.gameFramework.d.e c = gameEngine.bR.c(f, f2, f3, -1127220);
                if (c != null) {
                    c.G = 0.15f;
                    c.F = 1.0f;
                    c.ar = (short) 2;
            ...
            eVar.ar = (short) 2;
            if (wVar != null) {
                com.corrodinggames.rts.gameFramework.d.c.a(eVar, wVar);
            }
            return eVar;
            ...
            com.corrodinggames.rts.gameFramework.d.e b2 = gameEngine.bR.b(f, f2, f3, com.corrodinggames.rts.gameFramework.d.d.custom, z, this.priority);
            if (b2 == null) {
                return null;
            }
            b2.f471a = this;
            ...
            if (this.frameIndexRandom != 0) {
                b2.ap += com.corrodinggames.rts.gameFramework.f.a(-this.frameIndexRandom, this.frameIndexRandom);
                if (b2.ap < 0) {
                    b2.ap = 0;
                }
            }
            float a2 = f4 + this.pivotOffset + a(this.pivotOffsetRandom);
            ...
            if (this.xOffsetRelativeRandom != 0.0f || this.yOffsetRelativeRandom != 0.0f || this.xOffsetRelative != 0.0f || this.yOffsetRelative != 0.0f) {
                float k = com.corrodinggames.rts.gameFramework.f.k(a2);
                float j = com.corrodinggames.rts.gameFramework.f.j(a2);
            ...
            if (this.teamColorRatio != 0.0f && wVar != null) {
                ...
                if ((wVar instanceof com.corrodinggames.rts.game.f) && (amVar = ((com.corrodinggames.rts.game.f) wVar).j) != null) {
                    playerData = amVar.bX;
                }
                if (playerData != null) {
                    ...
                    int K = playerData.K();
                    b2.x = Color.a(a7, com.corrodinggames.rts.gameFramework.f.b((int) (b3 + (Color.b(K) * this.teamColorRatio)), 0, 255), com.corrodinggames.rts.gameFramework.f.b((int) (c2 + (Color.c(K) * this.teamColorRatio)), 0, 255), com.corrodinggames.rts.gameFramework.f.b((int) (d + (Color.d(K) * this.teamColorRatio)), 0, 255));
                    if (GameEngine.at()) {
            ...
            if (this.xSpeedRelative != 0.0f || this.ySpeedRelative != 0.0f || this.xSpeedRelativeRandom != 0.0f || this.ySpeedRelativeRandom != 0.0f) {
                float k2 = com.corrodinggames.rts.gameFramework.f.k(a2);
                float j2 = com.corrodinggames.rts.gameFramework.f.j(a2);
                float a8 = this.xSpeedRelative + a(this.xSpeedRelativeRandom);
                float a9 = this.ySpeedRelative + a(this.ySpeedRelativeRandom);
                b2.P += (k2 * a9) - (j2 * a8);
                b2.Q += (j2 * a9) + (k2 * a8);
            }
            ...
            if (this.animateFrameStartRandomAdd != 0) {
                b2.af += com.corrodinggames.rts.gameFramework.f.a(0, this.animateFrameStartRandomAdd);
            }
            ...
            if (wVar != null && this.attachedToUnit) {
                com.corrodinggames.rts.gameFramework.d.c.a(b2, wVar);
            }
            if (this.alsoPlaySound != null) {
                this.alsoPlaySound.a(f, f2, 1.0f);
            }
            if (i < 5 && this.alsoEmitEffects != null) {
                this.alsoEmitEffects.a(f, f2, f3, a2, wVar, i + 1, (short) 0);
            }
            return b2;
        }
    }
    ...
    public void a(l lVar, com.corrodinggames.rts.gameFramework.utility.ab abVar, String str) {
        ...
        if (b3 != null) {
            try {
                this.priority = com.corrodinggames.rts.gameFramework.d.h.valueOf(b3);
        ...
        com.corrodinggames.rts.gameFramework.m.e a2 = lVar.a(abVar, str, "image");
        if (a2 != null) {
            this.imageStrip = new com.corrodinggames.rts.gameFramework.d.g();
            this.imageStrip.i = a2;
        ...
        if (a2 != null && ((this.imageStrip.b >= this.imageStrip.i.m() || intValue != 1) && this.animateFrameEnd > intValue)) {
