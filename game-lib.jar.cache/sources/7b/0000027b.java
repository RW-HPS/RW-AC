...
public class b extends a implements Comparable {
    ...
    public int a(am amVar, boolean z) {
        int i = 9999;
        if (!z && this.b > 0) {
            i = com.corrodinggames.rts.gameFramework.f.c(9999, (int) (amVar.bX.credits / this.b));
        }
        if (this.c > 0.0f) {
    ...
    private void b(ae aeVar, boolean z, boolean z2, int i, boolean z3, am amVar, int i2) {
        ...
        if (this.b > 0 && 0 < i) {
            int i4 = l;
            if (amVar != null && amVar.bX.credits < this.b) {
                i4 = i2;
            }
    ...
    public b i(am amVar) {
        b bVar = new b();
        if (this.b > 0 && amVar.bX.credits < this.b) {
            bVar.b = this.b - ((int) amVar.bX.credits);
        }
        if (!this.k.c()) {
    ...
    public String a(am amVar, int i, boolean z) {
        String a2;
        String str = null;
        if (this.b > 0 && 0 < i && amVar.bX.credits < this.b) {
            if (0 == 0) {
