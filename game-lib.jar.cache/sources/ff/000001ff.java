...
public final class au {
    ...
    public boolean b(au auVar) {
        if (auVar == null || this.a != auVar.a || this.b != auVar.b || com.corrodinggames.rts.gameFramework.f.c(this.e - auVar.e) > 1.0f || com.corrodinggames.rts.gameFramework.f.c(this.f - auVar.f) > 1.0f || this.d != auVar.d || this.h != auVar.h) {
            return false;
        }
        return true;
    }
    ...
    public void a(GameOutputStream gameOutputStream) {
        gameOutputStream.writeEnum(this.a);
    ...
    public boolean f() {
        return this.a == av.attack || this.a == av.repair || this.a == av.reclaim || this.a == av.loadInto || this.a == av.loadUp || this.a == av.guard || this.a == av.touchTarget || this.a == av.follow;
    }
