...
public class b extends com.corrodinggames.rts.game.units.custom.a.a {
    ...
    public static void a(com.corrodinggames.rts.game.units.custom.l lVar, ab abVar, String str, String str2, com.corrodinggames.rts.game.units.custom.a.d dVar, String str3, boolean z) {
        ...
        com.corrodinggames.rts.game.units.custom.h a = abVar.a(lVar, str, str2 + "addWaypoint_target_nearestUnit_tagged", (com.corrodinggames.rts.game.units.custom.h) null);
        ...
        com.corrodinggames.rts.game.units.custom.h a2 = abVar.a(lVar, str, str2 + "addWaypoint_target_randomUnit_tagged", (com.corrodinggames.rts.game.units.custom.h) null);
        ...
        u a3 = abVar.a(lVar, str, str2 + "addWaypoint_triggerActionIfFailed", (u) null);
        u a4 = abVar.a(lVar, str, str2 + "addWaypoint_triggerActionIfMatched", (u) null);
        PointF a5 = abVar.a(str, str2 + "addWaypoint_position_offsetFromSelf", (PointF) null);
        PointF a6 = abVar.a(str, str2 + "addWaypoint_position_relativeOffsetFromSelf", (PointF) null);
        PointF a7 = abVar.a(str, str2 + "addWaypoint_position_randomOffsetFromSelf", (PointF) null);
    ...
    public boolean a(com.corrodinggames.rts.game.units.custom.j jVar, s sVar, PointF pointF, am amVar, int i) {
        ...
        if (this.c != null) {
            if (this.r != null) {
                ...
                int a = com.corrodinggames.rts.gameFramework.f.a((w) jVar, 0, mVar.size(), 0);
                jVar.bC++;
                if (a > mVar.size() - 1) {
                    a = mVar.size() - 1;
                }
                am amVar2 = (am) mVar.get(a);
