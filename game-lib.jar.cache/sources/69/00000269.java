...
public class bi {
    ...
    public static bi b(l lVar, String str, String str2, String str3, boolean z) {
        ...
        while (it.hasNext()) {
            ...
            if (!VariableScope.nullOrMissingString.equals(trim)) {
                ...
                if (biVar.a == null) {
                    biVar.a = new com.corrodinggames.rts.gameFramework.utility.m();
                }
                bkVar.b = i;
                if (str4 != null) {
                    if (!str4.endsWith(")")) {
    ...
    public void a(float f, float f2, float f3, float f4, com.corrodinggames.rts.game.units.am amVar, com.corrodinggames.rts.gameFramework.utility.m mVar, boolean z, int i, Projectile projectile, com.corrodinggames.rts.game.units.am amVar2) {
        if (this.a == null || this.a.size() == 0) {
            return;
        }
        int i2 = 0;
        int i3 = 0;
        if (amVar == null) {
            GameEngine.m5e("projectile spawn At: Skipping, source unit required");
            return;
        }
        Iterator it = this.a.iterator();
        while (it.hasNext()) {
            ...
            bh f5 = bkVar.a.f();
            if (f5 == null) {
                GameEngine.m5e("projectile spawn At: Skipping, projectileType==null");
            } else {
                for (int i4 = 0; i4 < bkVar.b; i4++) {
                    ...
                    if ((bkVar.c >= 1.0f || com.corrodinggames.rts.gameFramework.f.a(amVar, 0.0f, 1.0f, i3) <= bkVar.c) && i2 < bkVar.d && i <= bkVar.n) {
                        ...
                        Projectile a = j.a(amVar, -1, f5, f6, f7, f8, f9);
                        a.aD = i;
                        if (projectile != null && amVar != null) {
                            f5.a(amVar, a, projectile.l, projectile.n, projectile.o, -1.0f);
                        }
                        a(a, bkVar, amVar, projectile, amVar2);
                        i2++;
                        if (mVar != null) {
                            mVar.add(a);
                        }
    ...
    public void a(Projectile projectile, bk bkVar, com.corrodinggames.rts.game.units.am amVar, Projectile projectile2, com.corrodinggames.rts.game.units.am amVar2) {
        ...
        b.d = projectile2;
        b.e = amVar2;
        gameEngine.cc.a(projectile.eo, projectile.ep, 100.0f, null, 0.0f, b);
    }
}