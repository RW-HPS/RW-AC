...
public class p {
    ...
    static int b;
    static int c;
    static com.corrodinggames.rts.game.maps.g d;
    ...
    public static void a(r rVar, PointF pointF) {
        ...
        if (bVar == null) {
            GameEngine.m5e("setTerrainType called without map loaded");
            return;
        }
        int i = (int) (f * bVar.r);
        int i2 = (int) (f2 * bVar.s);
        if (!bVar.c(i, i2)) {
            GameEngine.m5e("setTerrainType out of map range");
        } else if (bVar.u == null) {
            GameEngine.m5e("setTerrainType mainLayer missing");
        } else {
            if (!bVar.R) {
                if (bVar.S) {
                    return;
                ...
                try {
                    if (bVar.v == null) {
                        bVar.v = new Layer(bVar, "grounddetails", bVar.width, bVar.height);
                        bVar.z.add(bVar.v);
                    }
                    if (bVar.w == null) {
                        bVar.w = new Layer(bVar, "grounddetails2", bVar.width, bVar.height);
                        bVar.z.add(bVar.w);
                    }
                    bVar.u.w = true;
                    bVar.v.w = true;
            ...
            try {
                com.corrodinggames.rts.game.maps.g a2 = bVar.a(rVar.b(), 0, 0);
                if (a2 == null) {
                    GameEngine.m5e("setTerrainType mapTile==null");
                    return;
                }
                com.corrodinggames.rts.game.maps.g a3 = bVar.u.a(i, i2);
                if (b == i && c == i2 && com.corrodinggames.rts.game.maps.g.a(d, a2)) {
                    return;
                }
                GameEngine.m5e("setTerrainType changing " + a3.b + " to " + a2.b + " at:" + i2 + "," + i2);
                ...
                for (int i3 = 0; i3 <= 4; i3++) {
                    ...
                    while (it.hasNext()) {
                        ...
                        a(rVar, a2, point.a, point.b, arrayList2);
                    }
    ...
    public static void a(r rVar, com.corrodinggames.rts.game.maps.g gVar, int i, int i2, ArrayList arrayList) {
        String a2;
    ...
    public static void a() {
        a = new s[SlickToAndroidKeycodes.AndroidCodes.KEYCODE_TV_CONTENTS_MENU];
        a(a(1), new s(2, 2));
        a(a(2), new s(0, 2));
        a(a(4), new s(0, 0));
        a(a(8), new s(2, 0));
    ...
    public static boolean a(r rVar, com.corrodinggames.rts.game.maps.g gVar, int i, int i2, int i3, int i4, String str) {
        com.corrodinggames.rts.game.maps.g a2;
        boolean z = false;
        com.corrodinggames.rts.game.maps.b bVar = GameEngine.getGameEngine().bL;
    ...
    public static void a(r rVar, com.corrodinggames.rts.game.maps.g gVar, com.corrodinggames.rts.game.maps.g gVar2, int i, int i2) {
        com.corrodinggames.rts.game.maps.b bVar = GameEngine.getGameEngine().bL;
        com.corrodinggames.rts.game.maps.g a2 = bVar.u.a(i, i2);
        com.corrodinggames.rts.game.maps.g a3 = bVar.v.a(i, i2);
        com.corrodinggames.rts.game.maps.g a4 = bVar.w.a(i, i2);
        r a5 = a(a3);
        r a6 = a(a4);
        if (a5 == rVar) {
            bVar.v.a(i, i2, null, false);
        ...
        if (com.corrodinggames.rts.game.maps.g.a(a2, gVar) || gVar2 == null) {
            return;
        }
        if (a3 != null) {
            if (a4 != null) {
    ...
    public static r a(com.corrodinggames.rts.game.maps.g gVar) {
        r[] values;
        if (gVar == null) {
            return null;
        }
    ...
    public static boolean a(r rVar, com.corrodinggames.rts.game.maps.g gVar, int i, int i2) {
        com.corrodinggames.rts.game.maps.b bVar = GameEngine.getGameEngine().bL;
        if (bVar.c(i, i2) && com.corrodinggames.rts.game.maps.g.a(bVar.u.a(i, i2), gVar)) {
            return true;
        }
        return false;
    }

    public static byte b(r rVar, com.corrodinggames.rts.game.maps.g gVar, int i, int i2) {
        byte b2 = 0;
        com.corrodinggames.rts.game.maps.b bVar = GameEngine.getGameEngine().bL;
        int i3 = bVar.width;
        int i4 = bVar.height;
