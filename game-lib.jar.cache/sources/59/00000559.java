...
/* renamed from: com.corrodinggames.rts.gameFramework.k.p */
...
public final class p {
    ...
    public final int a(o oVar, byte b) {
        return oVar.l[b][(this.a * oVar.h) + this.b];
    }

    public final void a(o oVar, byte b, int i) {
        oVar.l[b][(this.a * oVar.h) + this.b] = i;
    }

    public final void a(o oVar, byte b, boolean z) {
        if (z) {
            byte[] bArr = oVar.m[b];
            int i = (this.a * oVar.h) + this.b;
            bArr[i] = (byte) (bArr[i] | 16);
            return;
        }
        byte[] bArr2 = oVar.m[b];
        int i2 = (this.a * oVar.h) + this.b;
        bArr2[i2] = (byte) (bArr2[i2] & (-17));
    }

    public final boolean b(o oVar, byte b) {
        return oVar.l[b][(this.a * oVar.h) + this.b] >= oVar.i && (oVar.m[b][(this.a * oVar.h) + this.b] & 16) != 0;
    }

    public final byte c(o oVar, byte b) {
        return (byte) (oVar.m[b][(this.a * oVar.h) + this.b] & 7);
    }

    public final boolean d(o oVar, byte b) {
        return (oVar.m[b][(this.a * oVar.h) + this.b] & 8) != 0;
    }
    ...
    public final void a(o oVar, byte b, float f) {
        ...
        if (i < 0 || i > 7) {
            GameEngine.m5e("setCurrentDirectionFromAngle: dir:" + i + " direction:" + f);
            i = 0;
        }
        a(oVar, b, (byte) i);
    }
    ...
    public final boolean e(o oVar, byte b) {
        if (oVar.l[b][(this.a * oVar.h) + this.b] >= oVar.i) {
            return true;
        }
        return false;
    }
    ...
    public final boolean a(o oVar, byte b, p pVar) {
        ...
        pVar.a((short) (this.a - i), (short) (this.b - i2));
        return true;
    }
}