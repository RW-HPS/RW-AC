...
public class ListOperate_AddRoom implements Runnable {
    ...
    public void run() {
        ...
        try {
            try {
                ...
                APIEncryption.f571a.a(str, arrayList);
                ...
                GameNetAPIOperate.listAddBasicNameValuePair(arrayList, "private_token_2", f.b(f.b(gameEngine.bX.aR)));
                GameNetAPIOperate.listAddBasicNameValuePair(arrayList, "confirm", f.b("a" + f.b(gameEngine.bX.aR)));
                GameNetAPIOperate.b(arrayList);
                BufferedReader a2 = GameNetAPIOperate.a(arrayList, 15);
