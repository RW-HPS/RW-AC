...
public final class a {
    ...
    static ResourceBundle a(String str, Locale locale) {
        ...
        if (Locale.ROOT.equals(locale)) {
            GameEngine.m5e("Locale: Using " + str2 + " as locale");
            return a2;
        }
        String str3 = a(str, locale, true, true) + ".properties";
        PropertyResourceBundle a3 = a(str3);
        if (a3 == null) {
            GameEngine.m5e("Locale: No locale for " + str3 + " checking locale without variant ");
            str3 = a(str, locale, true, false) + ".properties";
            a3 = a(str3);
            if (a3 == null) {
                GameEngine.m5e("Locale: No locale for " + str3 + " checking locale without variant or country");
                str3 = a(str, locale, false, false) + ".properties";
                a3 = a(str3);
                if (a3 == null) {
                    GameEngine.m5e("Locale: No locale for " + str3 + " using base locale");
                    return a2;
                }
            }
        }
        GameEngine.m5e("Locale: Using " + str3 + " as locale");
        return new b(a3, a2);
    }
    ...
    public static synchronized void e() {
        ...
        if (a != null && b == z) {
            GameEngine.m5e("Locale.reload: skipping reload");
        }
        if (Build.VERSION.SDK_INT >= 9) {
            ResourceBundle.clearCache();
        }
        if (z) {
            GameEngine.m5e("Locale: forceEnglish");
            ...
            GameEngine.m5e("Locale: default targetLocale:" + locale);
            if (locale != null) {
                GameEngine.m5e("Locale: default targetLocale ISO3:" + locale.getISO3Language());
            }
            a = a("Strings", locale);
        }
        b = z;
    ...
    public static String c(String str) {
        ...
        while (matcher.find()) {
            ...
            if (a2 == null) {
                GameEngine.m5e("convertInlineBlocks: No key:" + group);
                a2 = "[No key: " + group + "]";
            }
