...
public final class e {
    ...
    public ay a = ay.defaultEffectTemplate;
    ...
    public void c() {
        this.a = ay.defaultEffectTemplate;
        this.q = h.verylow;
        this.b = null;
        this.c = false;
        this.d = false;
    ...
    public void b(float f) {
        ...
        if (this.v) {
            if (this.K > 0.0f) {
                ...
                this.P = f.a(this.P, 0.15f * f);
                this.Q = f.a(this.Q, 0.15f * f);
                this.Z = f.a(this.Z, 1.0f * f);
            }
        }
        this.I += this.P * f;
        this.J += this.Q * f;
    ...
    public boolean a(GameEngine gameEngine, boolean z) {
        ...
        if (!z) {
            d = f.d(this.I, this.J, this.K);
        } else {
            d = f.d(this.I, this.J, 0.0f);
        }
        boolean z2 = this.ar == 4;
        float f2 = 1.0f;
        if (this.G != 1.0f || this.F != 1.0f || this.H) {
            f2 = f.f(this.G, this.F, 1.0f - (this.V / this.W));
        ...
        if ((!z2 || this.L) && !f.a(gameEngine.cN, rectF)) {
            return false;
        }
        if (!this.e && !z2 && !this.f) {
            if (!gameEngine.bL.a(rectF.d(), rectF.e(), gameEngine.playerTeam)) {
                return false;
            }
            this.f = true;
        }
        ...
        if (this.S != 0.0f) {
            rectF.a(0.0f, f.j(((this.W - this.V) / this.T) * 360.0f) * this.S);
        }
        ...
        if (this.z >= 0.0f) {
            float a = Color.a(this.y) * 0.003921569f;
        ...
        if (z4 && GameEngine.at() && !z && this.B == null) {
            int b3 = f.b(255, (int) (f5 * 255.0f), (int) (f6 * 255.0f), (int) (f7 * 255.0f));
            if (C != null && D == b3) {
                this.B = C;
            } else {
        ...
        if (this.ar == 3) {
            if (c.k == null) {
                GameEngine.m5e("Loading displacement shader");
                try {
        ...
        if (!z4) {
            ...
            agVar = this.at;
            int b4 = f.b(255, (int) (f5 * 255.0f), (int) (f6 * 255.0f), (int) (f7 * 255.0f));
            float f10 = this.au - f;
            if (f10 < -0.01f || f10 > 0.01f || this.av != b4) {
                this.au = f;
                this.av = b4;
                this.at.b(f.b((int) (f * 255.0f), (int) (f5 * 255.0f), (int) (f6 * 255.0f), (int) (f7 * 255.0f)));
            }
        }
        if (this.aa != null) {
            ag agVar2 = agVar;
        ...
        if (this.L) {
            PointF d4 = f.d(this.M, this.N, this.O);
            yVar.a(rectF.a, rectF.b, d4.x - gameEngine.cw, d4.y - gameEngine.cx, this.ay.w);
        } else if (z) {
            if (gVar.j != null) {
