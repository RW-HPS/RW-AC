...
public class b {
    ...
    /* renamed from: a */
    boolean f468a = false;
    com.corrodinggames.rts.gameFramework.unitAction.e b = null;
    Paint c = new ag();
    RectF d = new RectF();
    float e = 0.0f;
    float f = 0.0f;
    ...
    public void b() {
        this.b = GameEngine.getGameEngine().bO.a(R.drawable.noise, false);
        this.f468a = true;
    }
    ...
    public void b(float f) {
        ...
        float f2 = (int) com.corrodinggames.rts.gameFramework.f.f((-gameEngine.cw) / 3.0f, 0.0f);
        float f3 = (int) com.corrodinggames.rts.gameFramework.f.f((-gameEngine.cx) / 3.0f, 0.0f);
