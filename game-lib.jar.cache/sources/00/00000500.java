...
public class a {
    ...
    public void f() {
        String[] split;
        boolean z;
        GameEngine.m2e("Loading mod selection");
        for (String str : GameEngine.getGameEngine().settingsEngine.modSettings.split(",")) {
            String[] split2 = str.split("\\|");
            if (split2.length != 3) {
                GameEngine.m2e("loadSelection: wrong count (" + split2.length + "):" + str);
            } else {
                ...
                if (str4.equals("enabled")) {
                    ...
                    GameEngine.m2e("loadSelection: Unknown option:" + str);
                }
                b c = c(str3);
                if (c == null) {
                    GameEngine.m2e("loadSelection: Did not find mod in settings:" + str2);
                } else {
                    c.f = z;
                    c.i = true;
                }
    ...
    public b a(String str, String str2, String str3, String str4, boolean z, boolean z2, boolean z3, int i) {
        ...
        c.z = z3;
        if (!c.z) {
            c.o = "Storage: " + com.corrodinggames.rts.gameFramework.file.a.d(c.q);
        }
        c.r();
        synchronized (this.d) {
    ...
    public void a(String str, boolean z, boolean z2) {
        GameEngine.m2e("loading mod custom units at:" + str);
        String[] h = com.corrodinggames.rts.gameFramework.file.a.h(str);
        if (h == null) {
        ...
        for (String str2 : h) {
            ...
            if (com.corrodinggames.rts.gameFramework.file.a.f(str3) || str2.endsWith(".ini")) {
                String e = f.e(str2);
                String str4 = str2;
                if (str4.contains("/")) {
    ...
    public ArrayList k() {
        ...
        if (steamEngine != null) {
            ...
            GameEngine.m2e("getAllModList: SteamEngine==null");
        }
        String m = ag.m();
        if (!com.corrodinggames.rts.gameFramework.file.a.f(m)) {
            GameEngine.m2e("Modded Custom '" + m + "' directory not found");
        } else {
            a(m, true, false);
        }
        String k = ag.k();
        if (!com.corrodinggames.rts.gameFramework.file.a.f(k)) {
            GameEngine.m2e("Modded Custom '" + k + "' directory not found");
        } else {
            a(k, false, true);
        }
        String l = ag.l();
        if (!com.corrodinggames.rts.gameFramework.file.a.f(l)) {
            GameEngine.m2e("Modded Custom '" + l + "' directory not found");
        } else {
            a(l, true, true);
        }
        ...
        while (it2.hasNext()) {
            b bVar2 = (b) it2.next();
            if (!bVar2.l) {
                GameEngine.m2e("Removing mod no longer found on system: " + bVar2.a());
                a(bVar2);
            }
        }
        GameEngine.m2e("========= Mods ===========");
        GameEngine.m2e("Number of mods:" + this.e.size());
        Iterator it3 = this.e.iterator();
        while (it3.hasNext()) {
            GameEngine.m2e("Mod: '" + ((b) it3.next()).a());
        }
        GameEngine.m2e("================================");
        GameEngine gameEngine = GameEngine.getGameEngine();
        if (gameEngine.settingsEngine.lastModCount == -1 || gameEngine.settingsEngine.modSettingsVersion < 1) {
            GameEngine.m2e("Disabling all new mods for first/new load");
            ...
            GameEngine.m2e("Too many new mods found, not enabling new mods");
            GameEngine.m2e("Number of mods:" + this.e.size() + " vs " + gameEngine.settingsEngine.lastModCount);
    ...
    public void a(boolean z, boolean z2) {
        ...
        if (!z2) {
            ...
            while (it.hasNext()) {
                b bVar = (b) it.next();
                if (bVar.R != null) {
                    GameEngine.m2e("re-enabling mod: " + bVar.a());
                }
                bVar.R = null;
                bVar.V.clear();
                bVar.S = null;
        ...
        if (z) {
            ...
            while (it2.hasNext()) {
                ...
                if (lVar.J != null && !lVar.J.f && lVar.J.R != null && l.a(lVar) == null) {
                    GameEngine.m2e("Was missing: " + lVar.M);
                    l.d.add(lVar);
                    i++;
                }
            }
    ...
    public void m() {
        ...
        if (gameEngine.dH != null) {
            ...
            GameEngine.m2e("No active callbacks");
        }
    }

    public String[] a(String[] strArr, String str) {
        String[] a2;
        GameEngine.m2e("addExtraMapsForPath: " + str);
        ArrayList arrayList = new ArrayList();
        if (strArr != null) {
        ...
        if (GameEngine.at() && "/SD/rusted_warfare_maps".equals(str) && (a2 = com.corrodinggames.rts.gameFramework.file.a.a("/SD/rustedWarfare/maps", true)) != null) {
    ...
    public ArrayList g(String str) {
        ...
        while (it.hasNext()) {
            ...
            if (z) {
                GameEngine.m2e("Adding extra map:" + cVar.f547a);
                arrayList.add(cVar);
            }
        }
        return arrayList;
    ...
    public void a(String str, b bVar) {
        ...
        if (str2.startsWith(str3)) {
            ...
            String o = com.corrodinggames.rts.gameFramework.file.a.o(str2);
            if (o.startsWith(str3)) {
                str2 = o.substring(str3.length());
                GameEngine.m2e("Mod path:" + bVar.q + " in map path without tag:" + str2);
            } else {
            ...
            if (split.length >= 2) {
                for (int length = split.length - 2; length >= 0; length--) {
                    ...
                    if (str2.startsWith("MOD|")) {
                        ...
                        b c = c(substring);
                        if (c == null) {
                            GameEngine.m2e("getLinkedModForFile: Failed to find mod with hash:" + substring);
                            return null;
                        }
                        return c;
                    }
