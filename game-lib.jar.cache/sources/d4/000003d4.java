...
public class e extends a {
    ...
    public boolean a(com.corrodinggames.rts.game.units.a.c cVar) {
        return this.c == com.corrodinggames.rts.game.units.a.c.a || this.c == cVar;
    }
    ...
    public float c() {
        ...
        return (this.a - GameEngine.getGameEngine().by) / i;
    }
    ...
    public int d() {
        return this.a - GameEngine.getGameEngine().by;
    }
    ...
    public static void c(am amVar, com.corrodinggames.rts.game.units.a.c cVar) {
        ...
        for (int i2 = mVar.a - 1; i2 >= 0; i2--) {
            ...
            if (aVar instanceof e) {
                e eVar = (e) aVar;
                if (cVar == com.corrodinggames.rts.game.units.a.c.a || eVar.a(cVar)) {
                    eVar.a = i - 1;
                }
            }
        }
