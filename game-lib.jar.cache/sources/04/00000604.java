...
public class ag extends af {
    ...
    static HashMap f672a = new HashMap();
    ...
    public static ah d(String str, boolean z) {
        ...
        String j = j(str);
        synchronized (f672a) {
            ah ahVar2 = (ah) f672a.get(j);
            if (ahVar2 == null) {
                if (z) {
                    e = j;
                } else {
                    e = com.corrodinggames.rts.gameFramework.e.a.e(j);
                }
                try {
                    try {
                        ahVar2 = new ah(j, e);
                        ...
                        if (com.corrodinggames.rts.gameFramework.e.a.g(j)) {
                            h("isDirectory: " + j);
                            str2 = "Failed to open .rwmod file (Appears to be a directory!). Please remove .rwmod from any folder names.";
                        }
                        com.corrodinggames.rts.gameFramework.e.a.b(str2 + VariableScope.nullOrMissingString);
                        return null;
                    }
    ...
    public static void e(String str, boolean z) {
        ...
        synchronized (f672a) {
            final ah ahVar = (ah) f672a.remove(j);
            if (ahVar != null) {
                GameEngine.m328e("Closing zip file: " + j);
                new Thread(new Runnable() { // from class: com.corrodinggames.rts.gameFramework.utility.ag.1
                    ...
                    public void run() {
                        ...
                        GameEngine.m328e("Running delayed close of zip: " + j);
                        ahVar.a();
                    }
                }).start();
            }
