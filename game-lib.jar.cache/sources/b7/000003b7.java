...
public abstract class h extends j {
    ...
    public static void K() {
        m = GameEngine.getGameEngine().bO.a(R.drawable.unit_icon_hover);
        n = PlayerData.a(m);
    }
    ...
    public void a(float f) {
        ...
        if (bT() && !this.bV && cK()) {
            ...
            if (this.l > 10.0f) {
                this.l = 0.0f;
                if (s_()) {
                    com.corrodinggames.rts.gameFramework.d.e b = GameEngine.getGameEngine().bR.b(this.eo + (com.corrodinggames.rts.gameFramework.f.k(this.cg) * 4.0f), this.ep + (com.corrodinggames.rts.gameFramework.f.j(this.cg) * 4.0f), 0.0f, com.corrodinggames.rts.gameFramework.d.d.custom, false, com.corrodinggames.rts.gameFramework.d.h.low);
                    if (b != null) {
                        b.aq = 0;
                        b.ap = 13;
                        b.ar = (short) 1;
