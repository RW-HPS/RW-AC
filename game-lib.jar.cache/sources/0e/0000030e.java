...
public class LogicBooleanLoader {
    ...
    public static LogicBoolean parseBooleanBlock(l lVar, String str, boolean z) {
        ...
        for (int i2 = 0; i2 < length; i2++) {
            ...
            if (f.c(lowerCase, str3)) {
                ...
                if (str3.equals("<>")) {
                    int a3 = al.a(breakOuterLayerBrackets, 0, strArr);
                    a = new ArrayList();
                    a.add(breakOuterLayerBrackets.substring(0, a3));
                    int i3 = a3 + 2;
                    if (i3 > breakOuterLayerBrackets.length() - 1) {
                        i3 = breakOuterLayerBrackets.length() - 1;
                    }
                    String substring = breakOuterLayerBrackets.substring(a3, i3);
                    if (!substring.endsWith("=")) {
                        substring = substring.substring(0, 1);
                    }
                    a.add(breakOuterLayerBrackets.substring(a3 + substring.length()));
                    str3 = substring;
                } else if (z4) {
                    a = al.a(breakOuterLayerBrackets, str3, z3, true);
                } else {
                    a = al.a(breakOuterLayerBrackets, str3, z3, false);
                }
                if (a.size() == 1) {
                    continue;
                } else if (str3.equals("=")) {
                    ...
                    if (!((String) a.get(0)).equals(VariableScope.nullOrMissingString) || a.size() != 2 || (!str3.equals("+") && !str3.equals("-"))) {
                        ArrayList arrayList = new ArrayList();
                        ...
                        if (requireBooleanChildren && ((newJoiner instanceof CompareJoinerBoolean.CompareNotEqualBoolean) || (newJoiner instanceof CompareJoinerBoolean.CompareEqualBoolean))) {
                            GameEngine.m5e(newJoiner.type() + " was set to require boolean. Workaround triggered. requireBooleanChildren:" + newJoiner.requireBooleanChildren());
    ...
    public static void setArgumentsWithMapping(ParameterMapping parameterMapping, Object obj, String str, l lVar, String str2) {
        ...
        if (str != null && !VariableScope.nullOrMissingString.equals(str)) {
            ...
            while (it.hasNext()) {
                ...
                int a = al.a(str5, "=");
                if (a > 0) {
                    str3 = str5.substring(0, a);
                    str4 = str5.substring(a + 1);
                    z = true;
                } else if (z) {
    ...
    public static Object getArgumentTextWithMapping(ParameterMapping.FieldOrMethod fieldOrMethod, Object obj) {
        if (fieldOrMethod != null && fieldOrMethod.field != null) {
            ...
            GameEngine.m5e("getArgumentTextWithMapping: method not supported");
            return "<method>";
        } else {
            GameEngine.m5e("getArgumentTextWithMapping: No method or field");
            return "<error>";
        }
    }
    ...
    public final class ArrayContextReader extends LogicBooleanContextWithDefault {
        ...
        public class ArrayGet extends ArrayFunction {
            ...
            public void setArgumentsRaw(String str, l lVar, String str2) {
                ...
                this.index = LogicBooleanLoader.parseNumberBlock(lVar, (String) a.get(0));
                if (this.index == null) {
        ...
        public class ArrayContains extends ArrayFunction {
            ...
            public void setArgumentsRaw(String str, l lVar, String str2) {
                ...
                ArrayList a = al.a(str, ",", false);
                validateNumberOfArguments(a.size());
                this.value = LogicBooleanLoader.parseBooleanBlock(lVar, (String) a.get(0), false);
                if (this.value == null) {
                    throw new BooleanParseException("Expected non-null argument");
                }
            }
            ...
            public static final int indexOf(y yVar, LogicBoolean logicBoolean, LogicBoolean logicBoolean2) {
                ...
                if (returnType == LogicBoolean.ReturnType.bool) {
                    ...
                    if (VariableScope.isMarker(readUnit)) {
                        ...
                        int i3 = readUnit.bX.site;
                        for (int i4 = 0; i4 < arraySize; i4++) {
                            am readUnit2 = logicBoolean.readArrayElement(yVar, i4).readUnit(yVar);
                            if (readUnit2 != null && f.j(f, readUnit2.eo) && f.j(f2, readUnit2.ep) && i3 == readUnit2.bX.site) {
                                return i4;
                            }
                        }
                        return -1;
