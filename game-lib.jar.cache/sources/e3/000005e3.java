...
public class f extends bq {
    ...
    public void a(boolean z) {
        ...
        if (this.k) {
            ...
            if (this.l) {
                GameEngine.m2e("Classic survial waves selected");
            }
            f();
            this.p = false;
        ...
        if (b3 != null) {
            if (b3.equalsIgnoreCase("none")) {
                ...
                throw new com.corrodinggames.rts.game.b.f("unknown win condition:" + b3);
            }
        }
        if (this.n) {
            this.f = this.e;
        ...
        while (it.hasNext()) {
            ...
            if ("team_info".equalsIgnoreCase(aVar2.d)) {
                ...
                PlayerData k = PlayerData.k(parseInt);
                if (k == null) {
                    ...
                    if (aVar2.b("basicAI") != null && gameEngine.P() && (k instanceof com.corrodinggames.rts.game.a.a)) {
                        GameEngine.print("Using basic AI:" + parseInt + " by map request");
                        ((com.corrodinggames.rts.game.a.a) k).aY = true;
                    }
                    String b4 = aVar2.b("lockAiDifficulty");
                    if (b4 != null && (k instanceof com.corrodinggames.rts.game.a.a)) {
                        GameEngine.print("Locking lockAiDifficulty:" + parseInt + " by map request to: " + b4);
                        com.corrodinggames.rts.game.a.a aVar3 = (com.corrodinggames.rts.game.a.a) k;
                        aVar3.x = Integer.parseInt(b4);
                        aVar3.y = true;
                        gameEngine.bX.aq();
                    }
                    if (aVar2.b("disabledAI") != null && gameEngine.P() && (k instanceof com.corrodinggames.rts.game.a.a)) {
                        GameEngine.print("Disabling AI:" + parseInt + " by map request");
                        ((com.corrodinggames.rts.game.a.a) k).aX = true;
                    }
                    String b5 = aVar2.b("allyGroup");
                    if (b5 != null && gameEngine.P()) {
                        k.r = Integer.parseInt(b5);
                    }
                    String b6 = aVar2.b("ai");
                    if (b6 != null) {
                        k.U = b6.equalsIgnoreCase("survival");
                    }
                }
            }
            ...
            if (b7 != null) {
                for (String str : b7.split(",")) {
                    ...
                    if (d == null) {
                        ...
                        GameEngine.m2e("Possible IDs:");
                        Iterator it11 = this.J.iterator();
                        while (it11.hasNext()) {
                            a aVar6 = (a) it11.next();
                            if (aVar6.b != null) {
                                GameEngine.m2e(aVar6.b);
                            }
                        }
                        GameEngine.m2e("--------");
                    } else {
        ...
        GameEngine.m2e("Found " + this.J.size() + " map triggers");
        ...
        while (it.hasNext()) {
            ...
            if (aVar.g == e.objective) {
                ...
                if (!z) {
                    ...
                    mVar.f657a = aVar;
                    this.g.add(mVar);
                    GameEngine.m2e("Found objective: " + mVar.a());
                }
            }
        }
    }
    ...
    public PointF f(String str) {
        i iVar = GameEngine.getGameEngine().bL.Q;
        if (iVar != null) {
    ...
    public void g(String str) {
        String[] split;
        GameEngine.m2e("Loading survival waves");
        this.N = true;
        int i = 0;
        int i2 = 0;
        for (String str2 : str.split("\n")) {
            ...
            if (gVar.a(str2)) {
                gVar.e = i + ((int) gVar.d);
                i = gVar.e;
                GameEngine.m2e("Adding wave " + i2 + " at " + gVar.e);
                this.O.add(gVar);
            }
        }
    }
    ...
    public void c(float f) {
        ...
        if (this.k) {
            if (!this.N) {
                ...
                } else if (!gameEngine.dq && !gameEngine.cb.j()) {
                    gameEngine.bS.G();
                }
            }
        }
        ...
        if (i > this.c + 1000) {
            ...
            if (!gameEngine.dq && !gameEngine.dt && !gameEngine.cb.j() && !z) {
                boolean z2 = true;
                boolean z3 = true;
                if (this.e == l.none) {
                    z2 = false;
                    ...
                    while (true) {
                        ...
                        if (gameEngine.bs.c(amVar.bX) && a(this.e, amVar)) {
                            z2 = false;
                            break;
                        }
                    }
                ...
                if (this.f == l.none) {
                    ...
                    while (true) {
                        ...
                        if (gameEngine.bs.d(amVar2.bX) && a(this.f, amVar2)) {
                            z3 = false;
                            break;
                        }
                    }
            ...
            if (this.k && !this.m) {
                ...
                while (it5.hasNext()) {
                    ...
                    if ((amVar3 instanceof e) || amVar3.bP) {
                        if (!amVar3.bV && !amVar3.u() && amVar3.bX == gameEngine.bs) {
                            z4 = false;
                        }
                    }
                }
    ...
    public void h(String str) {
        GameEngine.m2e("Map Script: " + str);
    }

    public void a(a aVar) {
        if (g()) {
            h("Activiated trigger:" + aVar.f645a + " (id:" + aVar.b + ")");
        }
    }

    public boolean g() {
        return f650a && GameEngine.getGameEngine().bl;
    }
