...
public final class aq {
    ...
    private static Point a(ao aoVar, int i2, int i3, int i4, int i5, int i6, int i7, int i8) {
        ...
        while (i11 > 0) {
            int i18 = i9;
            int i19 = i10;
            if (i7 != 0 && pathEngine.c(a2, i18, i19) < i7) {
                b.a(i18, i19);
                return b;
            }
            if (i6 != 0) {
                int b2 = pathEngine.b(a2, i18, i19);
                if (b2 == -1) {
                    b.a(i18, i19);
                    return b;
                }
            ...
            } else if (pathEngine.a(a2, i18, i19)) {
                b.a(i18, i19);
                return b;
            }
            if (i14 > 0) {
    ...
    public static PointF a(ao aoVar, float f2, float f3, float f4, float f5, int i2, int i3, boolean z) {
        ...
        j.setSite(c.c, c.d);
        if (d.y < e.y) {
            if ((z || !pathEngine.a(aoVar, i2, i3 - 1)) && com.corrodinggames.rts.gameFramework.f.a(d, e, i, h)) {
                z2 = true;
            }
        } else {
            if ((z || !pathEngine.a(aoVar, i2, i3 + 1)) && com.corrodinggames.rts.gameFramework.f.a(d, e, g, j)) {
                z2 = true;
            }
        }
        if (d.x < e.x) {
            if ((z || !pathEngine.a(aoVar, i2 - 1, i3)) && com.corrodinggames.rts.gameFramework.f.a(d, e, i, g)) {
                z2 = true;
            }
        } else {
            if ((z || !pathEngine.a(aoVar, i2 + 1, i3)) && com.corrodinggames.rts.gameFramework.f.a(d, e, h, j)) {
                z2 = false;
            }
        }
        if (z2) {
