...
public class b extends f implements com.corrodinggames.rts.game.units.d {
    ...
    public static void t_() {
        ...
        b = gameEngine.bO.a(AssetsID.drawable.builder_ship);
        a = gameEngine.bO.a(AssetsID.drawable.builder_ship_dead);
        c = gameEngine.bO.a(AssetsID.drawable.builder_ship_turret);
        e = PlayerData.a(b);
        d = a(b, b.m(), b.l());
    }
