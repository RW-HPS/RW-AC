...
public class SlickToAndroidKeycodes {
    ...
    static HashMap f662a;
    static HashMap b;
    static HashMap c;
    static HashMap d = a(SlickCodes.class);
    static HashMap e = a(AndroidCodes.class);
    static HashMap f = a(GdxCodes.class);
    static HashMap g;
    ...
    static HashMap a(Class cls) {
        Field[] fields;
        HashMap hashMap = new HashMap();
        for (Field field : cls.getFields()) {
            try {
                hashMap.put(field.getName().replace("KEYCODE_", VariableScope.nullOrMissingString).replace("KEY_", VariableScope.nullOrMissingString).replace("NUMPAD_", "NUMPAD").replace("NUM_", "NUMPAD"), Integer.valueOf(field.getInt(null)));
    ...
    public static void a() {
        f662a = a("slickToAndroidCodes", d, e);
        g = new HashMap();
        ...
        for (String str : d.keySet()) {
            ...
            if (f662a.get(Integer.valueOf(intValue)) == null) {
            }
    ...
    */
    public static java.util.HashMap a(java.lang.String r4, java.util.HashMap r5, java.util.HashMap r6) {
        /*
            Method dump skipped, instructions count: 263
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.corrodinggames.rts.gameFramework.utility.SlickToAndroidKeycodes.a(java.lang.String, java.util.HashMap, java.util.HashMap):java.util.HashMap");
    }
    ...
    public static int a(String str) {
        ...
        Integer num = (Integer) e.get(upperCase);
        if (num == null) {
    ...
    public static int b(int i) {
        Integer num = (Integer) f662a.get(Integer.valueOf(i));
        if (num == null) {
            return 0;
        }
        return num.intValue();
