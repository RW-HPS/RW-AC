    ...
    public static HashMap a(String str, HashMap hashMap, HashMap hashMap2) {
        ...
        for (String str2 : hashMap.keySet()) {
            ...
            if (hashMap3.get(Integer.valueOf(intValue)) == null) {
                hashMap3.put(Integer.valueOf(intValue), num);
            }
        ...
        if (arrayList.size() != 0) {
            ...
            while (it.hasNext()) {
                ...
                if (hashMap3.get(Integer.valueOf(((Integer) hashMap.get(str4)).intValue())) == null) {
                    str3 = str3 + str4 + ", ";
                }
            }
            GameEngine.m5e(str + ": Could not find keycode for: " + str3);
        }
        return hashMap3;
    }
