...
public class Mods extends ScriptContext {
    ...
    public void setModFilter(String str) {
        ...
        if (activeDocument == null) {
            GameEngine.m5e("loadMods: No Active Document");
            return;
        }
    ...
    public void applyModFilter() {
        ...
        if (elementById == null) {
            GameEngine.m5e("loadMods: Failed to find modList, wrong page?");
            return;
        }
        ...
        while (it.hasNext()) {
            ...
            b a = gameEngine.bZ.a(intValue);
            if (a == null) {
                GameEngine.m5e("Could not find mod with mod session id: " + intValue);
            } else {
                if (str != null) {
                    boolean z2 = false;
                    if (a.a() != null && a.a().toLowerCase(Locale.ROOT).contains(str)) {
                        z2 = true;
                    }
                    if (a.e() != null && a.e().toLowerCase(Locale.ROOT).contains(str)) {
                        z2 = true;
                    }
                    if (!z2) {
                        z = true;
    ...
    public void refreshModList() {
        ElementDocument activeDocument = this.libRocket.getActiveDocument();
        if (activeDocument == null) {
            GameEngine.m5e("refreshModList: No Active Document");
            return;
        }
        GameEngine.m5e("refreshModList");
        if (activeDocument.getElementById("modTemplate") == null) {
            GameEngine.m5e("refreshModList: Failed to find modTemplate, wrong page?");
            return;
        }
    ...
    public void loadMods() {
        ...
        if (elementById == null) {
            ...
            while (it.hasNext()) {
                ...
                String a = bVar.a();
                String str2 = VariableScope.nullOrMissingString;
                String replace = innerRML.replace("_NAME_", this.root.htmlString(a)).replace("_ID_", bVar.e);
                String str3 = bVar.R;
                if (str3 == null) {
    ...
    private void _saveModsCommon(boolean z) {
        ...
        if (z2) {
            GameEngine.m5e("mod changes made");
        } else {
            GameEngine.m5e("no mod changes made");
        }
        gameEngine.bZ.e();
    ...
    private void _saveModsMessages(boolean z) {
        GameEngine gameEngine = GameEngine.getGameEngine();
        int a = gameEngine.bZ.a(false);
        int b = gameEngine.bZ.b();
        if (gameEngine.netEngine.B) {
            GameEngine.m5e("savesMods: in network game");
            ...
            if (a == 0) {
                ...
                String str = "Note: " + a + " selected mods are still not loaded after reload";
                if (b > 0) {
                    str = "Warning: " + b + " selected mods had errors after reload";
                }
                this.root.showAlert(str);
            } else {
                String str2 = "Mod selection saved. But " + a + " mod(s) aren't loaded. Load them now?";
                if (!gameEngine.I()) {
    ...
    public void reloadModDataAsk() {
        if (GameEngine.getGameEngine().I()) {
            GameEngine.m5e("Menu active, reloading without asking");
            reloadModData();
            return;
        }
